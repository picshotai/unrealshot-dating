...
-- ==============================================================================
-- 9. DODO PAYMENTS & SUBSCRIPTIONS SYSTEM
-- ==============================================================================

-- 9a. Pricing Plans Table
create table if not exists public.dodo_pricing_plans (
  ...
  dodo_product_id text, -- set your Dodo product ID here
  is_active boolean not null default true,
...
insert into public.dodo_pricing_plans (
  ...
  30,
  'USD',
  'p_dating_59', -- update with your real dodo_product_id
  true,
...
-- 9c. Subscriptions / Access Passes
...
-- 9d. Webhook Events Table (Idempotent webhook tracking)
