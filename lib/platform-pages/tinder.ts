  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        ...
        "The standard is simple: the result should still look recognizably like you today. Keep the accurate frames that fit your life, use a Photo Retake when an otherwise strong image misses, and leave out anything that changes an important feature.",
      ],
    },
    {
