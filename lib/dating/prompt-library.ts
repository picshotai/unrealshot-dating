...
export type DatingPromptDefinition = {
  ...
  version: 5;
  /**
   * Interests this scene genuinely shows.
   *
   * Separate from `tags`, which exists only so a user can exclude content and
   * is guarded against holding anything else. This is the opposite direction:
   * it lets selection honour what a man said he does, so tapping a chip is a
   * promise rather than a nudge to the vibe weighting.
   *
   * Kept deliberately tight. A scene where a path happens to be visible does
   * not depict hiking, and claiming it would spend one of his three guaranteed
   * photos on a scene that does not show his thing.
   */
  depicts?: readonly InterestId[];
  /** Authored content tags, e.g. dog, alcohol, bicycle. Never inferred. */
  tags: string[];
  bucket: DatingBucket;
  slot: number;
...
export const DATING_PROMPTS = [
  ...
  },
  {
    ...
    "locations": {
      "urban": "a warm apartment kitchen",
      "outdoorsy": "a cabin kitchen corner",
      "homebody": "his own kitchen counter"
    },
    "backdrops": {
      "urban": "open shelving, hanging pans and a lit extractor",
      "outdoorsy": "timber cupboards, a stove and stacked firewood",
  ...
  },
  {
    ...
    "backdrops": {
      "urban": "a fridge door, a fruit bowl and warm under-cabinet light",
      "outdoorsy": "a butcher block, hung mugs and a dark window",
  ...
  },
  {
    ...
    "backdrops": {
      "urban": "a doorway through to a lit hallway and a coat hook",
      "outdoorsy": "a low beam, a stone floor and a dark corridor",
  ...
  },
  {
    ...
    "tags": [],
    "light": "Daylight floods in through the doorway he is standing in, so he is lit fully from the front while the interior behind him reads several stops darker.",
    "promptTemplate": "All references show the same man. Preserve his face, skin tone, hair, beard pattern, age, and natural asymmetry; this identity belongs to him alone. At {{location}}, wearing {{outfit}}. He stands in the open doorway with one hand high on the frame and his weight on the back foot. He looks straight to the lens. Five metres behind him, {{backdrop}} fall away into gentle blur. Daylight floods in through the doorway he is standing in, so he is lit fully from the front while the interior behind him reads several stops darker. A 9:16 full-length frame at eye level, Fujifilm GFX 100S, 80mm, f/2.8, 1/250, ISO 200. Retain tonal variation, faint under-eye texture, varied beard density, and natural highlights, with skin that keeps its own grain.",
    "locations": {
      "urban": "a painted apartment doorway",
      "outdoorsy": "a timber cabin doorway",
      "homebody": "his own front doorway"
    },
    "backdrops": {
      "urban": "a tiled stair landing, a radiator and a hall light",
      "outdoorsy": "a porch post, stacked logs and dark pines",
  ...
  },
  {
    ...
    "tags": [],
    "light": "Daylight floods in through the doorway he is standing in, so he is lit fully from the front while the interior behind him reads several stops darker.",
    "promptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. At {{location}}, wearing {{outfit}}. He pulls the door to behind him with one hand, keys closed in the other. He turns to the lens as it clicks. Three metres back, {{backdrop}} settle into soft tone. Daylight floods in through the doorway he is standing in, so he is lit fully from the front while the interior behind him reads several stops darker. A 3:4 waist-up frame at eye level, Canon R5, 85mm, f/2, 1/320, ISO 400. Keep real skin microtexture, grooming irregularities, soft highlight rolloff, and believable focus falloff, with pores and fine lines intact.",
    "locations": {
      "urban": "a painted apartment doorway",
      "outdoorsy": "a timber cabin doorway",
      "homebody": "his own front doorway"
  ...
  },
  {
    ...
    "tags": [],
    "light": "Daylight floods in through the doorway he is standing in, so he is lit fully from the front while the interior behind him reads several stops darker.",
    "promptTemplate": "Use the supplied photographs for identity. Keep his face shape, skin tone, hair, beard pattern, age, and asymmetry exactly as they appear, on him alone. At {{location}}, wearing {{outfit}}. He leans a shoulder on the doorframe with both hands in his pockets. He smiles off to his right, past the lens. Four metres behind him, {{backdrop}} render as soft shape and light. Daylight floods in through the doorway he is standing in, so he is lit fully from the front while the interior behind him reads several stops darker. A 3:4 handheld waist-up portrait from slightly above, handheld iPhone 15 Pro at 48mm equivalent, standard photo mode. Show distance-appropriate facial detail, flyaway hairs, and fabric creases, letting the lens render depth on its own.",
    "locations": {
      "urban": "a painted apartment doorway",
      "outdoorsy": "a timber cabin doorway",
      "homebody": "his own front doorway"
  ...
  },
  {
    ...
    "backdrops": {
      "urban": "a communal stair, a leaning bicycle and a strip of daylight",
      "outdoorsy": "a boot rack, a lantern hook and open ground",
  ...
  },
  {
    ...
    "tags": [],
    "light": "A wall lamp beside the door lights him from the side at head height, leaving a clean falloff across the bridge of his nose to the far cheek.",
    "promptTemplate": "All references show the same man. Preserve his face, skin tone, hair, beard pattern, age, and natural asymmetry; this identity belongs to him alone. At {{location}}, wearing {{outfit}}. He crouches to pick something up from the step, one hand on the ground, and rises with it. He looks up to the lens as he straightens. Seven metres behind him, {{backdrop}} open away and soften. A wall lamp beside the door lights him from the side at head height, leaving a clean falloff across the bridge of his nose to the far cheek. A 9:16 full-length frame from a low height, Fujifilm GFX 100S, 80mm, f/2.8, 1/250, ISO 200. Retain tonal variation, faint under-eye texture, varied beard density, and natural highlights, with skin that keeps its own grain.",
    "locations": {
      "urban": "a painted apartment doorway",
      "outdoorsy": "a timber cabin doorway",
      "homebody": "his own front doorway"
    ...
    "backdrops": {
      "urban": "a hallway running back, a mirror and a coat rail",
      "outdoorsy": "a covered porch, a bench and a dark treeline",
  ...
  },
  {
    ...
    "tags": [],
    "light": "A wall lamp beside the door lights him from the side at head height, leaving a clean falloff across the bridge of his nose to the far cheek.",
    "promptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. At {{location}}, wearing {{outfit}}. He stands square in the doorway with both hands loose at his sides. He holds the lens, keeping the posture he was already in. Three metres back, {{backdrop}} sit quietly out of focus. A wall lamp beside the door lights him from the side at head height, leaving a clean falloff across the bridge of his nose to the far cheek. A 3:4 chest-up frame at eye level, Canon R5, 85mm, f/2, 1/320, ISO 400. Keep real skin microtexture, grooming irregularities, soft highlight rolloff, and believable focus falloff, with pores and fine lines intact.",
    "locations": {
      "urban": "a painted apartment doorway",
      "outdoorsy": "a timber cabin doorway",
      "homebody": "his own front doorway"
  ...
  },
  {
    ...
    "tags": [],
    "light": "A wall lamp beside the door lights him from the side at head height, leaving a clean falloff across the bridge of his nose to the far cheek.",
    "promptTemplate": "Use the supplied photographs for identity. Keep his face shape, skin tone, hair, beard pattern, age, and asymmetry exactly as they appear, on him alone. At {{location}}, wearing {{outfit}}. He turns back in the doorway as if remembering something, one hand on the frame. He glances to the lens over his shoulder. Five metres behind him, {{backdrop}} fall into soft depth. A wall lamp beside the door lights him from the side at head height, leaving a clean falloff across the bridge of his nose to the far cheek. A 3:4 handheld waist-up portrait held slightly off-centre, handheld iPhone 15 Pro at 48mm equivalent, standard photo mode. Show distance-appropriate facial detail, flyaway hairs, and fabric creases, letting the lens render depth on its own.",
    "locations": {
      "urban": "a painted apartment doorway",
      "outdoorsy": "a timber cabin doorway",
      "homebody": "his own front doorway"
  ...
  },
  {
    ...
    "depicts": ["coffee", "cooking", "nightlife"],
    "tags": [],
  ...
  },
  {
    ...
    "promptTemplate": "All references show the same man. Preserve his face, skin tone, hair, beard pattern, age, and natural asymmetry; this identity belongs to him alone. At {{location}}, wearing {{outfit}}. He leans back against the parapet with one forearm along it and a glass low in the other hand. He looks to the lens as the night settles. An open bottle and three glasses stand at his end of the table, two of them half finished. He holds the near ground and the room opens deeper into the frame, with {{backdrop}} seven metres beyond in soft light. Strung bulbs run along the parapet above and behind him, rimming his hair while the rooftop floor bounces a warmer, weaker light back onto his face. A 3:4 waist-up frame at eye level, Sony A7S III, 35mm, f/2, 1/160, ISO 3200. Retain distance-appropriate facial detail, warm venue colour across his skin, fabric folds, and grain carried through shadow and background alike.",
    "locations": {
      "urban": "a rooftop bar at night",
      "outdoorsy": "a lodge terrace after dark",
      "homebody": "a shared roof terrace"
    },
    "backdrops": {
      "urban": "a parapet, strung bulbs and a lit skyline",
      "outdoorsy": "deck posts, a fire bowl and a black treeline",
  ...
  },
  {
    ...
    "light": "Strung bulbs run along the parapet above and behind him, rimming his hair while the rooftop floor bounces a warmer, weaker light back onto his face. A modest direct flash from the camera adds a half stop of fill across his face and lays one soft shadow behind him.",
    "promptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. At {{location}}, wearing {{outfit}}. He sets a glass down on the ledge with one hand and pushes both sleeves back. He turns to the lens. The table carries the middle of a shared meal: a board of food, spare cutlery and a chair angled away as if just left. He is closest to the lens with the room trailing back, and {{backdrop}} dissolve nine metres further off. Strung bulbs run along the parapet above and behind him, rimming his hair while the rooftop floor bounces a warmer, weaker light back onto his face. A modest direct flash from the camera adds a half stop of fill across his face and lays one soft shadow behind him. A 3:4 chest-up frame at eye level, Fujifilm X100V, 23mm, f/4, 1/125, ISO 800. Flash reveals honest texture, modest shine at the forehead, fabric creases, and the weave of the table top.",
    "locations": {
      "urban": "a rooftop bar at night",
      "outdoorsy": "a lodge terrace after dark",
      "homebody": "a shared roof terrace"
  ...
  },
  {
    ...
    "backdrops": {
      "urban": "a bar counter, hanging stems and city glow",
      "outdoorsy": "a timber counter, lanterns and dark hills",
  ...
  },
  {
    ...
    "tags": [],
    "light": "A low table lantern sits just in front of him and lights him from below the eyeline, catching his jaw and the underside of his brow as the sky behind goes fully dark.",
    "promptTemplate": "Use the supplied photographs for identity. Keep his face shape, skin tone, hair, beard pattern, age, and asymmetry exactly as they appear, on him alone. At {{location}}, wearing {{outfit}}. He sits back on a low bench with his forearms on his knees, jacket open. His eyes go out over the rooftops, past the lens. Two more places are set along the table, one chair pushed back at an angle and a napkin dropped beside it. The table runs from the near corner into the room, with {{backdrop}} six metres back and well out of focus. A low table lantern sits just in front of him and lights him from below the eyeline, catching his jaw and the underside of his brow as the sky behind goes fully dark. A 3:4 handheld waist-up portrait from slightly above, handheld iPhone 15 Pro at 35mm equivalent, standard photo mode. Preserve distance-appropriate facial detail, slight gesture motion, and ordinary phone texture with true venue colour.",
    "locations": {
      "urban": "a rooftop bar at night",
      "outdoorsy": "a lodge terrace after dark",
      "homebody": "a shared roof terrace"
  ...
  },
  {
    ...
    "promptTemplate": "All references show the same man. Preserve his face, skin tone, hair, beard pattern, age, and natural asymmetry; this identity belongs to him alone. At {{location}}, wearing {{outfit}}. He pushes off the parapet with one palm and turns back toward the room, hands loose. He looks to the lens mid-turn. The table carries the middle of a shared meal: a board of food, spare cutlery and a chair angled away as if just left. He is closest to the lens with the room trailing back, and {{backdrop}} dissolve nine metres further off. City glow rises from the streets below and behind him and reads cool on his shoulders, while a warm heater to his left carries the light on his face. A 9:16 full-length frame at eye level, Sony A7S III, 35mm, f/2, 1/160, ISO 3200. Retain distance-appropriate facial detail, warm venue colour across his skin, fabric folds, and grain carried through shadow and background alike.",
    "locations": {
      "urban": "a rooftop bar at night",
      "outdoorsy": "a lodge terrace after dark",
      "homebody": "a shared roof terrace"
    ...
    "backdrops": {
      "urban": "the roof edge, aerials and distant towers",
      "outdoorsy": "a rail, dark water and slope lights",
  ...
  },
  {
    ...
    "locations": {
      "urban": "a late-night food market",
      "outdoorsy": "an evening mountain-town stall",
      "homebody": "a neighbourhood night market"
    },
    "backdrops": {
  ...
  },
  {
    ...
    "tags": [],
    "light": "Bare bulbs hang over the stalls just above head height and throw warm light straight down, catching his cheekbones and leaving his eyes softly shadowed. A modest direct flash from the camera adds a half stop of fill across his face and lays one soft shadow behind him.",
    "promptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. At {{location}}, wearing {{outfit}}. He takes a small bag in one hand and tucks his change away with the other. He turns to the lens as he steps back. Two more places are set along the table, one chair pushed back at an angle and a napkin dropped beside it. The table runs from the near corner into the room, with {{backdrop}} six metres back and well out of focus. Bare bulbs hang over the stalls just above head height and throw warm light straight down, catching his cheekbones and leaving his eyes softly shadowed. A modest direct flash from the camera adds a half stop of fill across his face and lays one soft shadow behind him. A 3:4 chest-up frame at eye level, Fujifilm X100V, 23mm, f/4, 1/125, ISO 800. Flash reveals honest texture, modest shine at the forehead, fabric creases, and the weave of the table top.",
    "locations": {
      "urban": "a late-night food market",
      "outdoorsy": "an evening mountain-town stall",
      "homebody": "a neighbourhood night market"
  ...
  },
  {
    ...
    "tags": [],
    "light": "Bare bulbs hang over the stalls just above head height and throw warm light straight down, catching his cheekbones and leaving his eyes softly shadowed.",
    "promptTemplate": "Use the supplied photographs for identity. Keep his face shape, skin tone, hair, beard pattern, age, and asymmetry exactly as they appear, on him alone. At {{location}}, wearing {{outfit}}. He eats standing with both hands on the tray, elbows in. He glances off to his right, past the lens, at the next stall. A coat is folded over the chair beside him and a second cup sits cooling within reach. The rest of the table runs a couple of metres past him, and {{backdrop}} drop off five metres behind them. Bare bulbs hang over the stalls just above head height and throw warm light straight down, catching his cheekbones and leaving his eyes softly shadowed. A 3:4 handheld medium portrait with casual headroom, handheld iPhone 15 Pro at 35mm equivalent, standard photo mode. Preserve distance-appropriate facial detail, slight gesture motion, and ordinary phone texture with true venue colour.",
    "locations": {
      "urban": "a late-night food market",
      "outdoorsy": "an evening mountain-town stall",
      "homebody": "a neighbourhood night market"
  ...
  },
  {
    ...
    "tags": [],
    "light": "A griddle and stall lamps glow low to his right and light him warmly from the side at chest height, with the street behind him staying dark.",
    "promptTemplate": "Use the supplied photographs for identity. Keep his face shape, skin tone, hair, beard pattern, age, and asymmetry exactly as they appear, on him alone. At {{location}}, wearing {{outfit}}. He walks the row of stalls with a tray in one hand, weaving slightly. He looks back to the lens as he keeps moving. The table carries the middle of a shared meal: a board of food, spare cutlery and a chair angled away as if just left. He is closest to the lens with the room trailing back, and {{backdrop}} dissolve nine metres further off. A griddle and stall lamps glow low to his right and light him warmly from the side at chest height, with the street behind him staying dark. A 9:16 handheld full-length frame from a low natural height, handheld iPhone 15 Pro at 35mm equivalent, standard photo mode. Preserve distance-appropriate facial detail, slight gesture motion, and ordinary phone texture with true venue colour.",
    "locations": {
      "urban": "a late-night food market",
      "outdoorsy": "an evening mountain-town stall",
      "homebody": "a neighbourhood night market"
  ...
  },
  {
    ...
    "promptTemplate": "All references show the same man. Preserve his face, skin tone, hair, beard pattern, age, and natural asymmetry; this identity belongs to him alone. At {{location}}, wearing {{outfit}}. He stands under the awning with a tray on one hand while light rain runs off the edge behind him. He holds the lens. Two more places are set along the table, one chair pushed back at an angle and a napkin dropped beside it. The table runs from the near corner into the room, with {{backdrop}} six metres back and well out of focus. A lit awning above and ahead of him spills warm light down onto his face and shoulders, while the market behind him falls into grainy depth. A 3:4 waist-up frame at eye level, Sony A7S III, 35mm, f/2, 1/160, ISO 3200. Retain distance-appropriate facial detail, warm venue colour across his skin, fabric folds, and grain carried through shadow and background alike.",
    "locations": {
      "urban": "a late-night food market",
      "outdoorsy": "an evening mountain-town stall",
      "homebody": "a neighbourhood night market"
    ...
    "backdrops": {
      "urban": "a lit serving hatch, crates and a dark side street",
      "outdoorsy": "a canvas roof, stacked boxes and pines",
  ...
  },
  {
    ...
    "depicts": ["football"],
    "tags": [],
    "light": "A lit awning above and ahead of him spills warm light down onto his face and shoulders, while the market behind him falls into grainy depth. A modest direct flash from the camera adds a half stop of fill across his face and lays one soft shadow behind him.",
    "promptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. At {{location}}, wearing {{outfit}}. He wipes his fingers on a napkin with both hands and folds it away. He looks to the lens. A coat is folded over the chair beside him and a second cup sits cooling within reach. The rest of the table runs a couple of metres past him, and {{backdrop}} drop off five metres behind them. A lit awning above and ahead of him spills warm light down onto his face and shoulders, while the market behind him falls into grainy depth. A modest direct flash from the camera adds a half stop of fill across his face and lays one soft shadow behind him. A 3:4 chest-up frame at eye level, Fujifilm X100V, 23mm, f/4, 1/125, ISO 800. Flash reveals honest texture, modest shine at the forehead, fabric creases, and the weave of the table top.",
    "locations": {
      "urban": "a late-night food market",
      "outdoorsy": "an evening mountain-town stall",
      "homebody": "a neighbourhood night market"
  ...
  },
  {
    ...
    "depicts": ["surfing"],
    "tags": [],
    "light": "Hard midday sun comes almost straight down and the pale ground throws a strong second light back up, so his face is lit from above and below at once with very little shadow.",
    "promptTemplate": "All references show the same man. Preserve his face, skin tone, hair, beard pattern, age, and natural asymmetry; this identity belongs to him alone. At {{location}}, wearing {{outfit}}. He walks the water's edge with his shoes hooked on two fingers and his other hand loose. He looks to the lens as the water reaches his feet. Twenty metres behind him {{backdrop}} sit in gentle haze, the ground between them holding just enough detail to read. Hard midday sun comes almost straight down and the pale ground throws a strong second light back up, so his face is lit from above and below at once with very little shadow. A 9:16 full-body documentary frame with straight horizon lines, Leica Q2, 28mm, f/2.8, 1/250, ISO 400. Keep distance-appropriate facial detail, fabric wear, accurate hands, and real weather in the air.",
    "locations": {
      "urban": "a city beach promenade",
      "outdoorsy": "an open shoreline",
      "homebody": "a local lake beach"
    },
    "backdrops": {
      "urban": "a sea wall, pastel beach huts and open water",
      "outdoorsy": "wet sand, breaking surf and a headland",
  ...
  },
  {
    ...
    "tags": [],
    "light": "Hard midday sun comes almost straight down and the pale ground throws a strong second light back up, so his face is lit from above and below at once with very little shadow.",
    "promptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. At {{location}}, wearing {{outfit}}. He crouches at the water's edge with one hand flat on the damp ground. His eyes stay on the water, past the lens. {{backdrop}} lie thirty metres past him, dropping into pale atmospheric distance while the near ground stays legible. Hard midday sun comes almost straight down and the pale ground throws a strong second light back up, so his face is lit from above and below at once with very little shadow. A 3:4 three-quarter portrait with moderate environmental separation, Canon R5, 50mm, f/2.8, 1/320, ISO 200. Retain complexion variation, beard detail, clothing folds, and believable focus falloff toward the distance.",
    "locations": {
      "urban": "a city beach promenade",
      "outdoorsy": "an open shoreline",
      "homebody": "a local lake beach"
  ...
  },
  {
    ...
    "tags": [],
    "light": "Hard midday sun comes almost straight down and the pale ground throws a strong second light back up, so his face is lit from above and below at once with very little shadow.",
    "promptTemplate": "Use the supplied photographs for identity. Keep his face shape, skin tone, hair, beard pattern, age, and asymmetry exactly as they appear, on him alone. At {{location}}, wearing {{outfit}}. He stands with both hands on his hips facing the water, then turns his head back. He finds the lens over his shoulder. The ground opens fifteen metres to a middle distance and carries on to {{backdrop}} some sixty metres out, softening by layers. Hard midday sun comes almost straight down and the pale ground throws a strong second light back up, so his face is lit from above and below at once with very little shadow. A 4:3 half-body portrait with the setting in quiet detail, Fujifilm GFX 100S, 45mm, f/4, 1/250, ISO 200. Preserve gentle skin texture, tonal variation, accurate scale between him and the place, and honest environmental detail.",
    "locations": {
      "urban": "a city beach promenade",
      "outdoorsy": "an open shoreline",
      "homebody": "a local lake beach"
  ...
  },
  {
    ...
    "depicts": ["hiking"],
    "tags": [],
    "light": "Low sun sits out over the water directly behind him, burning the horizon and rimming his shoulders, with his face carried a full stop under that on light coming back off the wet ground.",
    "promptTemplate": "All references show the same man. Preserve his face, skin tone, hair, beard pattern, age, and natural asymmetry; this identity belongs to him alone. At {{location}}, wearing {{outfit}}. He stands at the water's edge with both forearms folded, wind moving his shirt. He looks out along the coast, past the lens. The view runs back from him through twelve metres of open ground to {{backdrop}}, all of it softening toward the horizon. Low sun sits out over the water directly behind him, burning the horizon and rimming his shoulders, with his face carried a full stop under that on light coming back off the wet ground. A 4:3 waist-up portrait with one useful foreground detail, Leica Q2, 28mm, f/2.8, 1/250, ISO 400. Keep distance-appropriate facial detail, fabric wear, accurate hands, and real weather in the air.",
    "locations": {
      "urban": "a city beach promenade",
      "outdoorsy": "an open shoreline",
      "homebody": "a local lake beach"
    ...
    "backdrops": {
      "urban": "a promenade rail, palms and a pier",
      "outdoorsy": "marram grass, a dune ridge and open sea",
  ...
  },
  {
    ...
    "tags": [],
    "light": "Low sun sits out over the water directly behind him, burning the horizon and rimming his shoulders, with his face carried a full stop under that on light coming back off the wet ground.",
    "promptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. At {{location}}, wearing {{outfit}}. He shakes a shoe out with one hand braced on his knee. He glances to the lens mid-motion. Ten metres of foreground lead the eye to him, and {{backdrop}} settle fifty metres further into soft blue depth. Low sun sits out over the water directly behind him, burning the horizon and rimming his shoulders, with his face carried a full stop under that on light coming back off the wet ground. A 3:4 knee-up portrait that keeps hands and carried objects clear, Canon R5, 50mm, f/2.8, 1/320, ISO 200. Retain complexion variation, beard detail, clothing folds, and believable focus falloff toward the distance.",
    "locations": {
      "urban": "a city beach promenade",
      "outdoorsy": "an open shoreline",
      "homebody": "a local lake beach"
  ...
  },
  {
    ...
    "tags": [],
    "light": "Low sun sits out over the water directly behind him, burning the horizon and rimming his shoulders, with his face carried a full stop under that on light coming back off the wet ground.",
    "promptTemplate": "Use the supplied photographs for identity. Keep his face shape, skin tone, hair, beard pattern, age, and asymmetry exactly as they appear, on him alone. At {{location}}, wearing {{outfit}}. He pushes wet hair back with one hand and lets the other fall. He smiles to the lens. He stands eight metres clear of the nearest edge, with {{backdrop}} stacked forty metres beyond and losing contrast with depth. Low sun sits out over the water directly behind him, burning the horizon and rimming his shoulders, with his face carried a full stop under that on light coming back off the wet ground. A 3:4 waist-up portrait with gentle medium-format separation, Fujifilm GFX 100S, 45mm, f/4, 1/250, ISO 200. Preserve gentle skin texture, tonal variation, accurate scale between him and the place, and honest environmental detail.",
    "locations": {
      "urban": "a city beach promenade",
      "outdoorsy": "an open shoreline",
      "homebody": "a local lake beach"
  ...
  },
  {
    ...
    "tags": [],
    "light": "Bright overcast comes off the whole sky and the pale ground at the water's edge, wrapping him evenly with a soft shadow only under his brow.",
    "promptTemplate": "All references show the same man. Preserve his face, skin tone, hair, beard pattern, age, and natural asymmetry; this identity belongs to him alone. At {{location}}, wearing {{outfit}}. He walks up the slope from the water with a towel over one shoulder and a hand swinging free. He looks to the lens as he reaches the top. {{backdrop}} lie thirty metres past him, dropping into pale atmospheric distance while the near ground stays legible. Bright overcast comes off the whole sky and the pale ground at the water's edge, wrapping him evenly with a soft shadow only under his brow. A 4:3 environmental portrait with him holding roughly half the frame, Leica Q2, 28mm, f/2.8, 1/250, ISO 400. Keep distance-appropriate facial detail, fabric wear, accurate hands, and real weather in the air.",
    "locations": {
      "urban": "a city beach promenade",
      "outdoorsy": "an open shoreline",
      "homebody": "a local lake beach"
    ...
    "backdrops": {
      "urban": "beach steps, a lifeguard hut and a wide bay",
      "outdoorsy": "a rock shelf, spray and a distant point",
  ...
  },
  {
    ...
    "tags": [],
    "light": "Bright overcast comes off the whole sky and the pale ground at the water's edge, wrapping him evenly with a soft shadow only under his brow.",
    "promptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. At {{location}}, wearing {{outfit}}. He sits on a low ledge with both palms beside him, ankles crossed. He looks out at the bay, past the lens. The ground opens fifteen metres to a middle distance and carries on to {{backdrop}} some sixty metres out, softening by layers. Bright overcast comes off the whole sky and the pale ground at the water's edge, wrapping him evenly with a soft shadow only under his brow. A 3:4 waist-up lifestyle portrait at eye level, Canon R5, 50mm, f/2.8, 1/320, ISO 200. Retain complexion variation, beard detail, clothing folds, and believable focus falloff toward the distance.",
    "locations": {
      "urban": "a city beach promenade",
      "outdoorsy": "an open shoreline",
      "homebody": "a local lake beach"
  ...
  },
  {
    ...
    "tags": [],
    "light": "Bright overcast comes off the whole sky and the pale ground at the water's edge, wrapping him evenly with a soft shadow only under his brow.",
    "promptTemplate": "Use the supplied photographs for identity. Keep his face shape, skin tone, hair, beard pattern, age, and asymmetry exactly as they appear, on him alone. At {{location}}, wearing {{outfit}}. He shoulders a bag with one hand and starts back up from the water. He turns to the lens as he goes. Twenty metres behind him {{backdrop}} sit in gentle haze, the ground between them holding just enough detail to read. Bright overcast comes off the whole sky and the pale ground at the water's edge, wrapping him evenly with a soft shadow only under his brow. A 4:3 environmental portrait with layered foreground, subject and distance, Fujifilm GFX 100S, 45mm, f/4, 1/250, ISO 200. Preserve gentle skin texture, tonal variation, accurate scale between him and the place, and honest environmental detail.",
    "locations": {
      "urban": "a city beach promenade",
      "outdoorsy": "an open shoreline",
      "homebody": "a local lake beach"
  ...
  },
  {
    ...
    "tags": [],
    "light": "Clear thin air lets the sun come from his left and rake hard across his face, with the shadow side falling deep because so little haze softens it.",
    "promptTemplate": "All references show the same man. Preserve his face, skin tone, hair, beard pattern, age, and natural asymmetry; this identity belongs to him alone. At {{location}}, wearing {{outfit}}. He reaches the top and stands with both hands on his hips, breathing hard. He looks to the lens. Ten metres of foreground lead the eye to him, and {{backdrop}} settle fifty metres further into soft blue depth. Clear thin air lets the sun come from his left and rake hard across his face, with the shadow side falling deep because so little haze softens it. A 9:16 full-body portrait at natural perspective, Leica Q2, 28mm, f/2.8, 1/250, ISO 400. Keep distance-appropriate facial detail, fabric wear, accurate hands, and real weather in the air.",
    "locations": {
      "urban": "a cable-car viewing terrace",
      "outdoorsy": "a high alpine saddle",
      "homebody": "a hill fort viewpoint"
    },
    "backdrops": {
      "urban": "a steel rail, cable towers and a valley far below",
      "outdoorsy": "a rock cairn, scree and layered ridges",
  ...
  },
  {
    ...
    "tags": [],
    "light": "Clear thin air lets the sun come from his left and rake hard across his face, with the shadow side falling deep because so little haze softens it.",
    "promptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. At {{location}}, wearing {{outfit}}. He rests one boot on a rock with a forearm across his knee, taking the view in. His eyes stay on the ridgeline, past the lens. He stands eight metres clear of the nearest edge, with {{backdrop}} stacked forty metres beyond and losing contrast with depth. Clear thin air lets the sun come from his left and rake hard across his face, with the shadow side falling deep because so little haze softens it. A 4:3 knee-up frame that keeps the horizon and travel context, Canon R5, 50mm, f/2.8, 1/320, ISO 200. Retain complexion variation, beard detail, clothing folds, and believable focus falloff toward the distance.",
    "locations": {
      "urban": "a cable-car viewing terrace",
      "outdoorsy": "a high alpine saddle",
      "homebody": "a hill fort viewpoint"
  ...
  },
  {
    ...
    "tags": [],
    "light": "Clear thin air lets the sun come from his left and rake hard across his face, with the shadow side falling deep because so little haze softens it.",
    "promptTemplate": "Use the supplied photographs for identity. Keep his face shape, skin tone, hair, beard pattern, age, and asymmetry exactly as they appear, on him alone. At {{location}}, wearing {{outfit}}. He pulls a hood up with both hands against the wind and laughs at the cold. He looks to the lens through it. The view runs back from him through twelve metres of open ground to {{backdrop}}, all of it softening toward the horizon. Clear thin air lets the sun come from his left and rake hard across his face, with the shadow side falling deep because so little haze softens it. A 9:16 full-body composition that preserves natural scale, Fujifilm GFX 100S, 45mm, f/4, 1/250, ISO 200. Preserve gentle skin texture, tonal variation, accurate scale between him and the place, and honest environmental detail.",
    "locations": {
      "urban": "a cable-car viewing terrace",
      "outdoorsy": "a high alpine saddle",
      "homebody": "a hill fort viewpoint"
  ...
  },
  {
    ...
    "tags": [],
    "light": "Flat cloud light sits directly overhead and lights him softly from above, while the pale ground below throws a clean fill up under his jaw.",
    "promptTemplate": "All references show the same man. Preserve his face, skin tone, hair, beard pattern, age, and natural asymmetry; this identity belongs to him alone. At {{location}}, wearing {{outfit}}. He leans on the terrace rail with both forearms and the valley dropping away behind. He turns his head to the lens. The ground opens fifteen metres to a middle distance and carries on to {{backdrop}} some sixty metres out, softening by layers. Flat cloud light sits directly overhead and lights him softly from above, while the pale ground below throws a clean fill up under his jaw. A 3:4 three-quarter frame from an ordinary walking distance, Leica Q2, 28mm, f/2.8, 1/250, ISO 400. Keep distance-appropriate facial detail, fabric wear, accurate hands, and real weather in the air.",
    "locations": {
      "urban": "a cable-car viewing terrace",
      "outdoorsy": "a high alpine saddle",
      "homebody": "a hill fort viewpoint"
    ...
    "backdrops": {
      "urban": "a terrace edge, glass panels and blue distance",
      "outdoorsy": "wind-bent grass, a snowfield and far peaks",
  ...
  },
  {
    ...
    "tags": [],
    "light": "Flat cloud light sits directly overhead and lights him softly from above, while the pale ground below throws a clean fill up under his jaw.",
    "promptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. At {{location}}, wearing {{outfit}}. He tightens a pack strap with one hand and settles the weight. He looks to the lens as it seats. Twenty metres behind him {{backdrop}} sit in gentle haze, the ground between them holding just enough detail to read. Flat cloud light sits directly overhead and lights him softly from above, while the pale ground below throws a clean fill up under his jaw. A 3:4 waist-up lifestyle portrait at eye level, Canon R5, 50mm, f/2.8, 1/320, ISO 200. Retain complexion variation, beard detail, clothing folds, and believable focus falloff toward the distance.",
    "locations": {
      "urban": "a cable-car viewing terrace",
      "outdoorsy": "a high alpine saddle",
      "homebody": "a hill fort viewpoint"
  ...
  },
  {
    ...
    "tags": [],
    "light": "Flat cloud light sits directly overhead and lights him softly from above, while the pale ground below throws a clean fill up under his jaw.",
    "promptTemplate": "Use the supplied photographs for identity. Keep his face shape, skin tone, hair, beard pattern, age, and asymmetry exactly as they appear, on him alone. At {{location}}, wearing {{outfit}}. He steps up onto a flat rock with one hand out for balance and straightens. He glances back to the lens. {{backdrop}} lie thirty metres past him, dropping into pale atmospheric distance while the near ground stays legible. Flat cloud light sits directly overhead and lights him softly from above, while the pale ground below throws a clean fill up under his jaw. A 9:16 full-body portrait at natural perspective, Fujifilm GFX 100S, 45mm, f/4, 1/250, ISO 200. Preserve gentle skin texture, tonal variation, accurate scale between him and the place, and honest environmental detail.",
    "locations": {
      "urban": "a cable-car viewing terrace",
      "outdoorsy": "a high alpine saddle",
      "homebody": "a hill fort viewpoint"
  ...
  },
  {
    ...
    "depicts": ["hiking"],
    "tags": [],
    "light": "Late sun breaks under the cloud base behind him and rims his outline, with his face lit frontally by the wide bright sky ahead of him.",
    "promptTemplate": "All references show the same man. Preserve his face, skin tone, hair, beard pattern, age, and natural asymmetry; this identity belongs to him alone. At {{location}}, wearing {{outfit}}. He stands at the very edge of the platform with both hands in his coat pockets, cloud below him. He looks to the lens. He stands eight metres clear of the nearest edge, with {{backdrop}} stacked forty metres beyond and losing contrast with depth. Late sun breaks under the cloud base behind him and rims his outline, with his face lit frontally by the wide bright sky ahead of him. A 4:3 environmental portrait with him holding roughly half the frame, Leica Q2, 28mm, f/2.8, 1/250, ISO 400. Keep distance-appropriate facial detail, fabric wear, accurate hands, and real weather in the air.",
    "locations": {
      "urban": "a cable-car viewing terrace",
      "outdoorsy": "a high alpine saddle",
      "homebody": "a hill fort viewpoint"
    ...
    "backdrops": {
      "urban": "a viewing platform, benches and cloud below",
      "outdoorsy": "a ridge path, loose rock and open sky",
  ...
  },
  {
    ...
    "tags": [],
    "light": "Late sun breaks under the cloud base behind him and rims his outline, with his face lit frontally by the wide bright sky ahead of him.",
    "promptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. At {{location}}, wearing {{outfit}}. He cups both hands round his mouth against the wind and drops them again. He smiles to the lens. The view runs back from him through twelve metres of open ground to {{backdrop}}, all of it softening toward the horizon. Late sun breaks under the cloud base behind him and rims his outline, with his face lit frontally by the wide bright sky ahead of him. A 3:4 chest-up portrait with the destination softly recognisable, Canon R5, 50mm, f/2.8, 1/320, ISO 200. Retain complexion variation, beard detail, clothing folds, and believable focus falloff toward the distance.",
    "locations": {
      "urban": "a cable-car viewing terrace",
      "outdoorsy": "a high alpine saddle",
      "homebody": "a hill fort viewpoint"
  ...
  },
  {
    ...
    "tags": [],
    "light": "Late sun breaks under the cloud base behind him and rims his outline, with his face lit frontally by the wide bright sky ahead of him.",
    "promptTemplate": "Use the supplied photographs for identity. Keep his face shape, skin tone, hair, beard pattern, age, and asymmetry exactly as they appear, on him alone. At {{location}}, wearing {{outfit}}. He turns away from the drop and starts back down the path, one hand trailing the rail. His eyes go to the ground, past the lens. Ten metres of foreground lead the eye to him, and {{backdrop}} settle fifty metres further into soft blue depth. Late sun breaks under the cloud base behind him and rims his outline, with his face lit frontally by the wide bright sky ahead of him. A 3:4 three-quarter portrait with balanced negative space, Fujifilm GFX 100S, 45mm, f/4, 1/250, ISO 200. Preserve gentle skin texture, tonal variation, accurate scale between him and the place, and honest environmental detail.",
    "locations": {
      "urban": "a cable-car viewing terrace",
      "outdoorsy": "a high alpine saddle",
      "homebody": "a hill fort viewpoint"
  ...
  },
  {
    ...
    "hobbyPromptTemplate": "All references show the same man. Preserve his face, skin tone, hair, beard pattern, age, and natural asymmetry; this identity belongs to him alone. Partway through {{hobby}}, he steadies the work with one hand and makes a small correction with the other. He looks up to the lens as it comes right. The space carries on eleven metres behind him, its own surfaces soft and legible. Light falls from above and slightly to his left, modelling his brow and leaving the far cheek a stop darker. A 9:16 three-quarter action frame with the face fully visible, Sony A1, 50mm, f/2.8, 1/1000, auto ISO. Keep joints, hands, feet, equipment and ground contact credible, with mild real warmth across his skin and damp hair at the temple.",
    "locations": {
      "urban": "a broad urban park path",
      "outdoorsy": "a lakeside trail",
      "homebody": "a leafy neighborhood greenway"
  ...
  },
  {
    ...
    "hobbyPromptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. He pauses in the middle of {{hobby}} with both hands still resting on what he is doing. He glances to the lens and holds it a moment. Nine metres of the venue open behind him and settle into soft tone. A broad source ahead of him and above lights his face frontally, with the depth behind falling away darker. A 9:16 three-quarter burst photograph with ordinary perspective, handheld iPhone 15 Pro burst, 35mm equivalent, standard photo mode. Preserve believable mechanics, movement outside the face, distance-appropriate skin, and ordinary phone texture.",
    "locations": {
      "urban": "a broad urban park path",
      "outdoorsy": "a lakeside trail",
      "homebody": "a leafy neighborhood greenway"
  ...
  },
  {
    ...
    "hobbyPromptTemplate": "Use the supplied photographs for identity. Keep his face shape, skin tone, hair, beard pattern, age, and asymmetry exactly as they appear, on him alone. He sets something down with both hands at a natural break in {{hobby}} and straightens his back. He finds the lens as he does. Behind him the working space recedes fourteen metres into gentle blur. Light comes across him from the right at head height, raking the texture of his sleeves and leaving a clean falloff. A 9:16 three-quarter photograph with activity context behind him, Fujifilm X-T5, 33mm, f/2.8, 1/500, ISO 400. Keep natural posture, accurate equipment, modest skin warmth, real breathing effort, and honest contrast.",
    "locations": {
      "urban": "a broad urban park path",
      "outdoorsy": "a lakeside trail",
      "homebody": "a leafy neighborhood greenway"
  ...
  },
  {
    ...
    "hobbyPromptTemplate": "All references show the same man. Preserve his face, skin tone, hair, beard pattern, age, and natural asymmetry; this identity belongs to him alone. He crouches to adjust something for {{hobby}}, one hand braced and the other working. He looks to the lens as he rises. The venue runs back sixteen metres behind him, softening as it goes. Overhead light pools on his hair and shoulders while the ground bounces a weaker fill up under his jaw. A 3:4 medium action frame that keeps active joints whole, Sony A1, 50mm, f/2.8, 1/1000, auto ISO. Keep joints, hands, feet, equipment and ground contact credible, with mild real warmth across his skin and damp hair at the temple.",
    "locations": {
      "urban": "a marked hill trail",
      "outdoorsy": "a wooded mountain path",
      "homebody": "a regional-park loop"
  ...
  },
  {
    ...
    "hobbyPromptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. He checks his grip before the next part of {{hobby}}, turning his hands over once. He looks up to the lens. Ten metres back, the space behind him holds soft, ordinary detail. A window or opening to his left carries the light across that side of his face, with the other side on bounce. A 3:4 medium snapshot that keeps the face identifiable, handheld iPhone 15 Pro burst, 35mm equivalent, standard photo mode. Preserve believable mechanics, movement outside the face, distance-appropriate skin, and ordinary phone texture.",
    "locations": {
      "urban": "a marked hill trail",
      "outdoorsy": "a wooded mountain path",
      "homebody": "a regional-park loop"
  ...
  },
  {
    ...
    "hobbyPromptTemplate": "Use the supplied photographs for identity. Keep his face shape, skin tone, hair, beard pattern, age, and asymmetry exactly as they appear, on him alone. He rests both forearms on whatever {{hobby}} has him working at and takes a breath. He turns to the lens. The room or ground behind him falls away thirteen metres into quiet blur. Soft light from above and behind rims his shoulders while his face rides on light returning off the surface in front. A 3:4 medium portrait taken during the activity, Fujifilm X-T5, 33mm, f/2.8, 1/500, ISO 400. Keep natural posture, accurate equipment, modest skin warmth, real breathing effort, and honest contrast.",
    "locations": {
      "urban": "a marked hill trail",
      "outdoorsy": "a wooded mountain path",
      "homebody": "a regional-park loop"
  ...
  },
  {
    ...
    "hobbyPromptTemplate": "All references show the same man. Preserve his face, skin tone, hair, beard pattern, age, and natural asymmetry; this identity belongs to him alone. He finishes a run of {{hobby}} and lets both hands drop, breathing out. He looks to the lens with it still settling. Eighteen metres of the venue sit behind him, blurred but clearly a real place. Light arrives from ahead and above at an angle, giving short controlled shadows under his brow and nose. A 4:3 environmental action frame that explains the activity, Sony A1, 50mm, f/2.8, 1/1000, auto ISO. Keep joints, hands, feet, equipment and ground contact credible, with mild real warmth across his skin and damp hair at the temple.",
    "locations": {
      "urban": "a forest exercise clearing",
      "outdoorsy": "a lodge deck beside trees",
      "homebody": "a quiet local park lawn"
  ...
  },
  {
    ...
    "hobbyPromptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. He wipes his palms and takes hold again for the next part of {{hobby}}. He glances to the lens between the two. The space opens twelve metres behind him and loses its edges. A strong source behind him edges his hair and shoulders, with his face carried a stop under it on ambient fill. A 4:3 environmental snapshot that includes the path, handheld iPhone 15 Pro burst, 35mm equivalent, standard photo mode. Preserve believable mechanics, movement outside the face, distance-appropriate skin, and ordinary phone texture.",
    "locations": {
      "urban": "a forest exercise clearing",
      "outdoorsy": "a lodge deck beside trees",
      "homebody": "a quiet local park lawn"
  ...
  },
  {
    ...
    "hobbyPromptTemplate": "Use the supplied photographs for identity. Keep his face shape, skin tone, hair, beard pattern, age, and asymmetry exactly as they appear, on him alone. He steps back from {{hobby}} to look at what he has done, one hand still resting on it. He turns to the lens. Fifteen metres back the surroundings soften into plain tone. Even light reaches him from the whole space above, leaving a gentle shadow only beneath his chin. A 4:3 environmental portrait with natural outdoor depth, Fujifilm X-T5, 33mm, f/2.8, 1/500, ISO 400. Keep natural posture, accurate equipment, modest skin warmth, real breathing effort, and honest contrast.",
    "locations": {
      "urban": "a forest exercise clearing",
      "outdoorsy": "a lodge deck beside trees",
      "homebody": "a quiet local park lawn"
  ...
  },
  {
    ...
    "hobbyPromptTemplate": "All references show the same man. Preserve his face, skin tone, hair, beard pattern, age, and natural asymmetry; this identity belongs to him alone. He carries something across for {{hobby}}, both hands occupied and his weight shifting. He looks to the lens mid-step. The venue runs seventeen metres back and softens by layers. Light comes low from his right and rakes across him, catching the edge of his jaw and one forearm. A 9:16 full-body action frame from sideline height, Sony A1, 50mm, f/2.8, 1/1000, auto ISO. Keep joints, hands, feet, equipment and ground contact credible, with mild real warmth across his skin and damp hair at the temple.",
    "locations": {
      "urban": "a riverside running route",
      "outdoorsy": "a golden-hour trail path",
      "homebody": "a familiar park loop"
  ...
  },
  {
    ...
    "hobbyPromptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. He sets up for {{hobby}}, placing things with both hands until they sit right. He looks to the lens once they do. Eleven metres behind him the space drops into soft depth. A bright opening ahead lights his face fully from the front while the interior behind reads much darker. A 9:16 handheld full-body frame from a safe practical distance, handheld iPhone 15 Pro burst, 35mm equivalent, standard photo mode. Preserve believable mechanics, movement outside the face, distance-appropriate skin, and ordinary phone texture.",
    "locations": {
      "urban": "a riverside running route",
      "outdoorsy": "a golden-hour trail path",
      "homebody": "a familiar park loop"
  ...
  },
  {
    ...
    "hobbyPromptTemplate": "Use the supplied photographs for identity. Keep his face shape, skin tone, hair, beard pattern, age, and asymmetry exactly as they appear, on him alone. He kneels to reach something low in {{hobby}}, one palm flat for balance. He looks up to the lens. Behind him the working area carries on twelve metres, gently out of focus. Overhead light drops onto his head and shoulders, with a soft upward fill off the floor keeping his eyes readable. A 9:16 full-body documentary photograph with balanced ground contact, Fujifilm X-T5, 33mm, f/2.8, 1/500, ISO 400. Keep natural posture, accurate equipment, modest skin warmth, real breathing effort, and honest contrast.",
    "locations": {
      "urban": "a riverside running route",
      "outdoorsy": "a golden-hour trail path",
      "homebody": "a familiar park loop"
  ...
  },
  {
    ...
    "hobbyPromptTemplate": "All references show the same man. Preserve his face, skin tone, hair, beard pattern, age, and natural asymmetry; this identity belongs to him alone. He holds the position {{hobby}} actually puts him in and takes one steady breath. He meets the lens and leaves everything as it was. The venue opens nineteen metres behind him into soft, honest depth. Light from above and one side models his face, leaving the far cheek in quiet shadow. A 4:3 environmental action frame that explains the activity, Sony A1, 50mm, f/2.8, 1/1000, auto ISO. Keep joints, hands, feet, equipment and ground contact credible, with mild real warmth across his skin and damp hair at the temple.",
    "locations": {
  ...
  },
  {
    ...
    "hobbyPromptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. He adjusts something small with his fingers partway through {{hobby}} and sets it back. He looks up to the lens. Ten metres of the space behind him blur into ordinary background. A source close on his left throws warm light across that side of his face and falls off quickly to the right. A 4:3 environmental snapshot that includes the path, handheld iPhone 15 Pro burst, 35mm equivalent, standard photo mode. Preserve believable mechanics, movement outside the face, distance-appropriate skin, and ordinary phone texture.",
    "locations": {
      "urban": "a shaded city-park bench",
      "outdoorsy": "a trailhead rest bench",
      "homebody": "a neighborhood park bench"
  ...
  },
  {
    ...
    "hobbyPromptTemplate": "Use the supplied photographs for identity. Keep his face shape, skin tone, hair, beard pattern, age, and asymmetry exactly as they appear, on him alone. He straightens up from {{hobby}} and rolls one shoulder out, the other hand still on the work. He turns to the lens. Fourteen metres back the surroundings settle into soft shape. Light comes from behind and above, edging his outline, with his face lit softly by what bounces back off the room. A 4:3 environmental portrait with natural outdoor depth, Fujifilm X-T5, 33mm, f/2.8, 1/500, ISO 400. Keep natural posture, accurate equipment, modest skin warmth, real breathing effort, and honest contrast.",
    "locations": {
      "urban": "a shaded city-park bench",
      "outdoorsy": "a trailhead rest bench",
      "homebody": "a neighborhood park bench"
  ...
  },
  {
    ...
    "hobbyPromptTemplate": "All references show the same man. Preserve his face, skin tone, hair, beard pattern, age, and natural asymmetry; this identity belongs to him alone. He is well into {{hobby}} with both hands busy and his attention on the work. He lifts his eyes to the lens while his hands keep going. The place runs back sixteen metres and softens into depth. Light falls from overhead and slightly ahead, catching his brow and shoulders and leaving his jaw underneath in shadow. A 9:16 full-body action frame from sideline height, Sony A1, 50mm, f/2.8, 1/1000, auto ISO. Keep joints, hands, feet, equipment and ground contact credible, with mild real warmth across his skin and damp hair at the temple.",
    "locations": {
  ...
  },
  {
    ...
    "hobbyPromptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. He pauses over {{hobby}}, both hands resting either side of it while he thinks the next part through. He glances to the lens. Twelve metres behind him the space loses detail into soft tone. A wide source to his side splits his face cleanly, one half lit and the other holding on room bounce. A 9:16 handheld full-body frame from a safe practical distance, handheld iPhone 15 Pro burst, 35mm equivalent, standard photo mode. Preserve believable mechanics, movement outside the face, distance-appropriate skin, and ordinary phone texture.",
    "locations": {
      "urban": "a landscaped hill path",
      "outdoorsy": "a moderate mountain trail",
      "homebody": "a sloped local greenway"
  ...
  },
  {
    ...
    "hobbyPromptTemplate": "Use the supplied photographs for identity. Keep his face shape, skin tone, hair, beard pattern, age, and asymmetry exactly as they appear, on him alone. He packs one thing away from {{hobby}} with both hands and pauses with it held. He looks to the lens. Behind him the venue recedes twenty metres, its own furniture softening as it goes. Soft frontal light reaches him over the camera position and lands evenly, with the depth behind a stop or more darker. A 9:16 full-body documentary photograph with balanced ground contact, Fujifilm X-T5, 33mm, f/2.8, 1/500, ISO 400. Keep natural posture, accurate equipment, modest skin warmth, real breathing effort, and honest contrast.",
    "locations": {
      "urban": "a landscaped hill path",
      "outdoorsy": "a moderate mountain trail",
      "homebody": "a sloped local greenway"
  ...
  },
  {
    ...
    "light": "Early sun comes low from his left and stretches long shadows across the grass, catching one side of his face and the dog beside him.",
    "promptTemplate": "All references show the same man. Preserve his face, skin tone, hair, beard pattern, age, and natural asymmetry; this identity belongs to him alone. At {{location}}, wearing {{outfit}}. He walks with the lead looped once round one hand, matching the pace beside him. He looks down at it, off past the lens. {{backdrop}} sit twenty-five metres beyond him, dropping into soft outdoor depth. Early sun comes low from his left and stretches long shadows across the grass, catching one side of his face and the dog beside him. A 9:16 full-body action frame from sideline height, Sony A1, 50mm, f/2.8, 1/1000, auto ISO. Keep joints, hands, feet, equipment and ground contact credible, with mild real warmth across his skin and damp hair at the temple.",
    "locations": {
      "urban": "a city park dog run",
      "outdoorsy": "an open field path",
      "homebody": "a quiet neighbourhood green"
    },
    "backdrops": {
      "urban": "a fenced run, a water trough and plane trees",
      "outdoorsy": "long grass, a gate and a distant treeline",
  ...
  },
  {
    ...
    "light": "Early sun comes low from his left and stretches long shadows across the grass, catching one side of his face and the dog beside him.",
    "promptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. At {{location}}, wearing {{outfit}}. He crouches with one hand flat on the grass and the other loose, waiting. He glances up to the lens. The ground runs back ten metres to {{backdrop}}, held just out of focus. Early sun comes low from his left and stretches long shadows across the grass, catching one side of his face and the dog beside him. A 9:16 three-quarter burst photograph with ordinary perspective, handheld iPhone 15 Pro burst, 35mm equivalent, standard photo mode. Preserve believable mechanics, movement outside the face, distance-appropriate skin, and ordinary phone texture.",
    "locations": {
      "urban": "a city park dog run",
      "outdoorsy": "an open field path",
      "homebody": "a quiet neighbourhood green"
  ...
  },
  {
    ...
    "light": "Early sun comes low from his left and stretches long shadows across the grass, catching one side of his face and the dog beside him.",
    "promptTemplate": "Use the supplied photographs for identity. Keep his face shape, skin tone, hair, beard pattern, age, and asymmetry exactly as they appear, on him alone. At {{location}}, wearing {{outfit}}. He straightens up from unclipping the lead, coiling it into one hand. He smiles to the lens. The path opens twelve metres behind him to {{backdrop}}, which soften as the ground falls away. Early sun comes low from his left and stretches long shadows across the grass, catching one side of his face and the dog beside him. A 9:16 full-body documentary photograph with balanced ground contact, Fujifilm X-T5, 33mm, f/2.8, 1/500, ISO 400. Keep natural posture, accurate equipment, modest skin warmth, real breathing effort, and honest contrast.",
    "locations": {
      "urban": "a city park dog run",
      "outdoorsy": "an open field path",
      "homebody": "a quiet neighbourhood green"
  ...
  },
  {
    ...
    "light": "Flat morning cloud lights the whole park evenly from above, with the wet grass throwing a weak green fill up under his jaw.",
    "promptTemplate": "All references show the same man. Preserve his face, skin tone, hair, beard pattern, age, and natural asymmetry; this identity belongs to him alone. At {{location}}, wearing {{outfit}}. He throws underarm across the grass, arm following through, and watches it go. His eyes track it, past the lens. Fifteen metres behind him, {{backdrop}} blur gently with the movement of the air. Flat morning cloud lights the whole park evenly from above, with the wet grass throwing a weak green fill up under his jaw. A 9:16 three-quarter action frame with the face fully visible, Sony A1, 50mm, f/2.8, 1/1000, auto ISO. Keep joints, hands, feet, equipment and ground contact credible, with mild real warmth across his skin and damp hair at the temple.",
    "locations": {
      "urban": "a city park dog run",
      "outdoorsy": "an open field path",
      "homebody": "a quiet neighbourhood green"
    ...
    "backdrops": {
      "urban": "a park path, litter bins and open lawn",
      "outdoorsy": "a farm track, hedgerow and rolling ground",
  ...
  },
  {
    ...
    "light": "Flat morning cloud lights the whole park evenly from above, with the wet grass throwing a weak green fill up under his jaw.",
    "promptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. At {{location}}, wearing {{outfit}}. He wipes both palms down his thighs after the throw and waits. He looks to the lens. Thirty metres out, {{backdrop}} settle into pale distance while his own footing stays sharp. Flat morning cloud lights the whole park evenly from above, with the wet grass throwing a weak green fill up under his jaw. A 3:4 knee-up candid with small natural movement at the edges, handheld iPhone 15 Pro burst, 35mm equivalent, standard photo mode. Preserve believable mechanics, movement outside the face, distance-appropriate skin, and ordinary phone texture.",
    "locations": {
      "urban": "a city park dog run",
      "outdoorsy": "an open field path",
      "homebody": "a quiet neighbourhood green"
  ...
  },
  {
    ...
    "light": "Flat morning cloud lights the whole park evenly from above, with the wet grass throwing a weak green fill up under his jaw.",
    "promptTemplate": "Use the supplied photographs for identity. Keep his face shape, skin tone, hair, beard pattern, age, and asymmetry exactly as they appear, on him alone. At {{location}}, wearing {{outfit}}. He bends to clip the lead back on, one hand steady on the collar. He looks up to the lens as it clicks. Eighteen metres back, {{backdrop}} lose their edges while the ground between stays readable. Flat morning cloud lights the whole park evenly from above, with the wet grass throwing a weak green fill up under his jaw. A 3:4 medium portrait taken during the activity, Fujifilm X-T5, 33mm, f/2.8, 1/500, ISO 400. Keep natural posture, accurate equipment, modest skin warmth, real breathing effort, and honest contrast.",
    "locations": {
      "urban": "a city park dog run",
      "outdoorsy": "an open field path",
      "homebody": "a quiet neighbourhood green"
  ...
  },
  {
    ...
    "light": "Sun breaks through the trees behind him and rims his shoulders, while his face rides on the soft bounce off the open path ahead.",
    "promptTemplate": "All references show the same man. Preserve his face, skin tone, hair, beard pattern, age, and natural asymmetry; this identity belongs to him alone. At {{location}}, wearing {{outfit}}. He walks the path with both hands in his pockets and the lead hooked over one wrist. He looks to the lens as he passes. The ground runs back ten metres to {{backdrop}}, held just out of focus. Sun breaks through the trees behind him and rims his shoulders, while his face rides on the soft bounce off the open path ahead. A 9:16 full-body action frame from sideline height, Sony A1, 50mm, f/2.8, 1/1000, auto ISO. Keep joints, hands, feet, equipment and ground contact credible, with mild real warmth across his skin and damp hair at the temple.",
    "locations": {
      "urban": "a city park dog run",
      "outdoorsy": "an open field path",
      "homebody": "a quiet neighbourhood green"
    ...
    "backdrops": {
      "urban": "railings, a kiosk and a bright open green",
      "outdoorsy": "a stile, seed heads and a wooded ridge",
  ...
  },
  {
    ...
    "light": "Sun breaks through the trees behind him and rims his shoulders, while his face rides on the soft bounce off the open path ahead.",
    "promptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. At {{location}}, wearing {{outfit}}. He stops to wait, one hand resting on a fence rail, patient. His eyes stay down the path, past the lens. The path opens twelve metres behind him to {{backdrop}}, which soften as the ground falls away. Sun breaks through the trees behind him and rims his shoulders, while his face rides on the soft bounce off the open path ahead. A 4:3 environmental snapshot that includes the path, handheld iPhone 15 Pro burst, 35mm equivalent, standard photo mode. Preserve believable mechanics, movement outside the face, distance-appropriate skin, and ordinary phone texture.",
    "locations": {
      "urban": "a city park dog run",
      "outdoorsy": "an open field path",
      "homebody": "a quiet neighbourhood green"
  ...
  },
  {
    ...
    "light": "Sun breaks through the trees behind him and rims his shoulders, while his face rides on the soft bounce off the open path ahead.",
    "promptTemplate": "Use the supplied photographs for identity. Keep his face shape, skin tone, hair, beard pattern, age, and asymmetry exactly as they appear, on him alone. At {{location}}, wearing {{outfit}}. He laughs and shakes his head with one hand raised, mid-stride. He looks to the lens through it. {{backdrop}} sit twenty-five metres beyond him, dropping into soft outdoor depth. Sun breaks through the trees behind him and rims his shoulders, while his face rides on the soft bounce off the open path ahead. A 3:4 knee-up photograph that keeps kit and hands coherent, Fujifilm X-T5, 33mm, f/2.8, 1/500, ISO 400. Keep natural posture, accurate equipment, modest skin warmth, real breathing effort, and honest contrast.",
    "locations": {
      "urban": "a city park dog run",
      "outdoorsy": "an open field path",
      "homebody": "a quiet neighbourhood green"
  ...
  },
  {
    ...
    "promptTemplate": "All references show the same man. Preserve his face, skin tone, hair, beard pattern, age, and natural asymmetry; this identity belongs to him alone. At {{location}}, wearing {{outfit}}. He holds a ball on one hip with the other hand on his knee, catching his breath. He looks up to the lens. Thirty metres out, {{backdrop}} settle into pale distance while his own footing stays sharp. Bright open sky sits overhead and slightly ahead, lighting his face frontally with a short shadow under his brow and a clean edge on his shoulders. A 3:4 medium action frame that keeps active joints whole, Sony A1, 50mm, f/2.8, 1/1000, auto ISO. Keep joints, hands, feet, equipment and ground contact credible, with mild real warmth across his skin and damp hair at the temple.",
    "locations": {
      "urban": "a floodlit outdoor court",
      "outdoorsy": "a grass pitch by the trees",
      "homebody": "a local recreation ground"
    },
    "backdrops": {
      "urban": "a chain-link fence, a hoop and city rooftops",
      "outdoorsy": "goalposts, a mown stripe and dark firs",
  ...
  },
  {
    ...
    "light": "Bright open sky sits overhead and slightly ahead, lighting his face frontally with a short shadow under his brow and a clean edge on his shoulders.",
    "promptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. At {{location}}, wearing {{outfit}}. He bounces a ball twice with one hand and catches it flat. His eyes stay on the hoop, past the lens. Eighteen metres back, {{backdrop}} lose their edges while the ground between stays readable. Bright open sky sits overhead and slightly ahead, lighting his face frontally with a short shadow under his brow and a clean edge on his shoulders. A 9:16 full-body action frame from sideline height, handheld iPhone 15 Pro burst, 35mm equivalent, standard photo mode. Preserve believable mechanics, movement outside the face, distance-appropriate skin, and ordinary phone texture.",
    "locations": {
      "urban": "a floodlit outdoor court",
      "outdoorsy": "a grass pitch by the trees",
      "homebody": "a local recreation ground"
  ...
  },
  {
    ...
    "promptTemplate": "All references show the same man. Preserve his face, skin tone, hair, beard pattern, age, and natural asymmetry; this identity belongs to him alone. At {{location}}, wearing {{outfit}}. He jogs backwards a couple of steps with both hands raised and ready, then stops. He grins to the lens. The path opens twelve metres behind him to {{backdrop}}, which soften as the ground falls away. Low light from the side of the playing area rakes across him at chest height, modelling one side of his face while the far side falls dark. A 9:16 full-body documentary photograph with balanced ground contact, Sony A1, 50mm, f/2.8, 1/1000, auto ISO. Keep joints, hands, feet, equipment and ground contact credible, with mild real warmth across his skin and damp hair at the temple.",
    "locations": {
      "urban": "a floodlit outdoor court",
      "outdoorsy": "a grass pitch by the trees",
      "homebody": "a local recreation ground"
    ...
    "backdrops": {
      "urban": "court markings, floodlight poles and a low wall",
      "outdoorsy": "a touchline, long grass and a hedgerow",
  ...
  },
  {
    ...
    "light": "Low light from the side of the playing area rakes across him at chest height, modelling one side of his face while the far side falls dark.",
    "promptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. At {{location}}, wearing {{outfit}}. He rests both hands on the fence rail at the side of the court, one foot up on the bottom bar. He looks to the lens. {{backdrop}} sit twenty-five metres beyond him, dropping into soft outdoor depth. Low light from the side of the playing area rakes across him at chest height, modelling one side of his face while the far side falls dark. A 3:4 knee-up frame with hands and kit inside the image, handheld iPhone 15 Pro burst, 35mm equivalent, standard photo mode. Preserve believable mechanics, movement outside the face, distance-appropriate skin, and ordinary phone texture.",
    "locations": {
      "urban": "a floodlit outdoor court",
      "outdoorsy": "a grass pitch by the trees",
      "homebody": "a local recreation ground"
  ...
  },
  {
    ...
    "promptTemplate": "All references show the same man. Preserve his face, skin tone, hair, beard pattern, age, and natural asymmetry; this identity belongs to him alone. At {{location}}, wearing {{outfit}}. He walks off with a ball under one arm and his other hand rubbing the back of his neck. He looks to the lens. Eighteen metres back, {{backdrop}} lose their edges while the ground between stays readable. Late sun comes almost level from behind the far end of the ground, rimming his hair and shoulders, with his face lit softly from the front by the open sky. A 9:16 full-body action frame from sideline height, Sony A1, 50mm, f/2.8, 1/1000, auto ISO. Keep joints, hands, feet, equipment and ground contact credible, with mild real warmth across his skin and damp hair at the temple.",
    "locations": {
      "urban": "a floodlit outdoor court",
      "outdoorsy": "a grass pitch by the trees",
      "homebody": "a local recreation ground"
    ...
    "backdrops": {
      "urban": "a practice wall, painted lines and evening sky",
      "outdoorsy": "a pitch corner, a treeline and open ground",
  ...
  },
  {
    ...
    "tags": [],
    "light": "A single work lamp clamped above the bench throws hard light straight down onto his hands and forearms, with his face catching the spill and the room behind going black.",
    "promptTemplate": "All references show the same man. Preserve his face, skin tone, hair, beard pattern, age, and natural asymmetry; this identity belongs to him alone. At {{location}}, wearing {{outfit}}. He works at the bench with both hands on a piece, head down, then lifts his chin. He looks to the lens. The street runs back nine metres to {{backdrop}}, everything past him going soft and warm. A single work lamp clamped above the bench throws hard light straight down onto his hands and forearms, with his face catching the spill and the room behind going black. A 3:4 waist-up frame at working distance, Leica Q2, 28mm, f/2.8, 1/250, auto ISO 800-3200. Retain distance-appropriate facial detail, fabric wear, true reflections, and available-light colour exactly as the street gives it.",
    "locations": {
      "urban": "a shared workshop bench",
      "outdoorsy": "a timber outbuilding bench",
      "homebody": "a garage workbench at home"
    },
    "backdrops": {
      "urban": "pegboard, hung tools and a roller door",
      "outdoorsy": "plank walls, stacked timber and a small window",
  ...
  },
  {
    ...
    "tags": [],
    "light": "A single work lamp clamped above the bench throws hard light straight down onto his hands and forearms, with his face catching the spill and the room behind going black.",
    "promptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. At {{location}}, wearing {{outfit}}. He wipes his hands on a rag and drops it on the bench. His eyes stay on the work, past the lens. He stands four metres clear of {{backdrop}}, which fall away into grainy shadow and lit edges. A single work lamp clamped above the bench throws hard light straight down onto his hands and forearms, with his face catching the spill and the room behind going black. A 3:4 chest-up portrait with mixed light falling across the face, Sony A7S III, 35mm, f/2, 1/125, ISO 3200. Spread grain through shadows and background as well as skin, keeping mixed colour temperature and natural highlights.",
    "locations": {
      "urban": "a shared workshop bench",
      "outdoorsy": "a timber outbuilding bench",
      "homebody": "a garage workbench at home"
  ...
  },
  {
    ...
    "tags": [],
    "light": "A single work lamp clamped above the bench throws hard light straight down onto his hands and forearms, with his face catching the spill and the room behind going black.",
    "promptTemplate": "Use the supplied photographs for identity. Keep his face shape, skin tone, hair, beard pattern, age, and asymmetry exactly as they appear, on him alone. At {{location}}, wearing {{outfit}}. He leans both palms on the bench edge and takes a breath, sleeves pushed back. He looks up to the lens. Six metres behind him, {{backdrop}} break into soft discs of practical light. A single work lamp clamped above the bench throws hard light straight down onto his hands and forearms, with his face catching the spill and the room behind going black. A 3:4 three-quarter snapshot with slight ambient movement behind him, compact 35mm camera, f/4, 1/60, ISO 800, restrained direct flash. Flash reveals honest texture, modest shine, fabric creases, and one natural shadow cast behind him.",
    "locations": {
      "urban": "a shared workshop bench",
      "outdoorsy": "a timber outbuilding bench",
      "homebody": "a garage workbench at home"
  ...
  },
  {
    ...
    "depicts": ["cycling"],
    "tags": [],
    "light": "Daylight comes through a high dusty window to his left and cuts across the bench, modelling one side of his face while the far side holds on ambient bounce.",
    "promptTemplate": "All references show the same man. Preserve his face, skin tone, hair, beard pattern, age, and natural asymmetry; this identity belongs to him alone. At {{location}}, wearing {{outfit}}. He turns something over in both hands, checking it against the light. His eyes stay on it, past the lens. Fifteen metres beyond him, {{backdrop}} smear into slow ambient movement. Daylight comes through a high dusty window to his left and cuts across the bench, modelling one side of his face while the far side holds on ambient bounce. A 3:4 chest-up frame at working distance, Leica Q2, 28mm, f/2.8, 1/250, auto ISO 800-3200. Retain distance-appropriate facial detail, fabric wear, true reflections, and available-light colour exactly as the street gives it.",
    "locations": {
      "urban": "a shared workshop bench",
      "outdoorsy": "a timber outbuilding bench",
      "homebody": "a garage workbench at home"
    ...
    "backdrops": {
      "urban": "a bench vice, coiled cable and a dusty window",
      "outdoorsy": "a workbench, sawhorses and daylight through boards",
  ...
  },
  {
    ...
    "tags": [],
    "light": "Daylight comes through a high dusty window to his left and cuts across the bench, modelling one side of his face while the far side holds on ambient bounce.",
    "promptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. At {{location}}, wearing {{outfit}}. He reaches up to unhook a tool with one hand and brings it down. He glances to the lens. Twenty metres out, {{backdrop}} reduce to shape and glow while the pavement near him stays sharp. Daylight comes through a high dusty window to his left and cuts across the bench, modelling one side of his face while the far side holds on ambient bounce. A 3:4 waist-up night portrait with available context, Sony A7S III, 35mm, f/2, 1/125, ISO 3200. Spread grain through shadows and background as well as skin, keeping mixed colour temperature and natural highlights.",
    "locations": {
      "urban": "a shared workshop bench",
      "outdoorsy": "a timber outbuilding bench",
      "homebody": "a garage workbench at home"
  ...
  },
  {
    ...
    "tags": [],
    "light": "Daylight comes through a high dusty window to his left and cuts across the bench, modelling one side of his face while the far side holds on ambient bounce.",
    "promptTemplate": "Use the supplied photographs for identity. Keep his face shape, skin tone, hair, beard pattern, age, and asymmetry exactly as they appear, on him alone. At {{location}}, wearing {{outfit}}. He sits back on a stool with one boot on the rung and both hands resting on his thighs. He looks to the lens. {{backdrop}} sit twelve metres back, their lamps and lit windows blooming gently out of focus. Daylight comes through a high dusty window to his left and cuts across the bench, modelling one side of his face while the far side holds on ambient bounce. A 9:16 full-body flash snapshot at believable distance, compact 35mm camera, f/4, 1/60, ISO 800, restrained direct flash. Flash reveals honest texture, modest shine, fabric creases, and one natural shadow cast behind him.",
    "locations": {
      "urban": "a shared workshop bench",
      "outdoorsy": "a timber outbuilding bench",
      "homebody": "a garage workbench at home"
  ...
  },
  {
    ...
    "depicts": ["music"],
    "tags": [],
    "light": "Warm bulbs strung along the wall behind him rim his shoulders, and the pale bench surface throws a soft light back up into his face.",
    "promptTemplate": "All references show the same man. Preserve his face, skin tone, hair, beard pattern, age, and natural asymmetry; this identity belongs to him alone. At {{location}}, wearing {{outfit}}. He sits with a guitar across one knee, one hand on the neck and the other resting over the strings. He looks up to the lens. He stands four metres clear of {{backdrop}}, which fall away into grainy shadow and lit edges. Warm bulbs strung along the wall behind him rim his shoulders, and the pale bench surface throws a soft light back up into his face. A 3:4 waist-up frame at working distance, Leica Q2, 28mm, f/2.8, 1/250, auto ISO 800-3200. Retain distance-appropriate facial detail, fabric wear, true reflections, and available-light colour exactly as the street gives it.",
    "locations": {
      "urban": "a shared workshop bench",
      "outdoorsy": "a timber outbuilding bench",
      "homebody": "a garage workbench at home"
    ...
    "backdrops": {
      "urban": "an amp, leaning cases and a bare bulb",
      "outdoorsy": "a stool, a guitar case and a dark corner",
  ...
  },
  {
    ...
    "tags": [],
    "light": "Warm bulbs strung along the wall behind him rim his shoulders, and the pale bench surface throws a soft light back up into his face.",
    "promptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. At {{location}}, wearing {{outfit}}. He leans over to adjust a dial with one finger, the other hand steadying the case. His eyes stay on the dial, past the lens. Six metres behind him, {{backdrop}} break into soft discs of practical light. Warm bulbs strung along the wall behind him rim his shoulders, and the pale bench surface throws a soft light back up into his face. A 3:4 chest-up portrait with mixed light falling across the face, Sony A7S III, 35mm, f/2, 1/125, ISO 3200. Spread grain through shadows and background as well as skin, keeping mixed colour temperature and natural highlights.",
    "locations": {
      "urban": "a shared workshop bench",
      "outdoorsy": "a timber outbuilding bench",
      "homebody": "a garage workbench at home"
  ...
  },
  {
    ...
    "tags": [],
    "light": "Warm bulbs strung along the wall behind him rim his shoulders, and the pale bench surface throws a soft light back up into his face.",
    "promptTemplate": "Use the supplied photographs for identity. Keep his face shape, skin tone, hair, beard pattern, age, and asymmetry exactly as they appear, on him alone. At {{location}}, wearing {{outfit}}. He stands and lifts the case by its handle in one hand, ready to go. He looks to the lens. The street runs back nine metres to {{backdrop}}, everything past him going soft and warm. Warm bulbs strung along the wall behind him rim his shoulders, and the pale bench surface throws a soft light back up into his face. A 9:16 handheld full-length frame from a low natural height, compact 35mm camera, f/4, 1/60, ISO 800, restrained direct flash. Flash reveals honest texture, modest shine, fabric creases, and one natural shadow cast behind him.",
    "locations": {
      "urban": "a shared workshop bench",
      "outdoorsy": "a timber outbuilding bench",
      "homebody": "a garage workbench at home"
  ...
  },
  {
    ...
    "tags": [],
    "light": "Open shade on the street lights him evenly from above, with the pavement bouncing a clean fill that keeps his eyes readable head to toe.",
    "promptTemplate": "All references show the same man. Preserve his face, skin tone, hair, beard pattern, age, and natural asymmetry; this identity belongs to him alone. At {{location}}, wearing {{outfit}}. He walks the middle of the empty street with both hands loose and his jacket open. He holds the lens as he comes. Twenty metres out, {{backdrop}} reduce to shape and glow while the pavement near him stays sharp. Open shade on the street lights him evenly from above, with the pavement bouncing a clean fill that keeps his eyes readable head to toe. A 9:16 full-length street frame with straight surrounding lines, Leica Q2, 28mm, f/2.8, 1/250, auto ISO 800-3200. Retain distance-appropriate facial detail, fabric wear, true reflections, and available-light colour exactly as the street gives it.",
    "locations": {
      "urban": "a long open city street",
      "outdoorsy": "a wide small-town main street",
      "homebody": "a quiet residential street"
    },
    "backdrops": {
      "urban": "a receding street wall, parked cars and a bright far end",
      "outdoorsy": "timber verandas, a pickup and open hills",
  ...
  },
  {
    ...
    "tags": [],
    "light": "Open shade on the street lights him evenly from above, with the pavement bouncing a clean fill that keeps his eyes readable head to toe.",
    "promptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. At {{location}}, wearing {{outfit}}. He stops and turns square to the camera, hands at his sides, weight even. He holds the lens, keeping the stance he already had. {{backdrop}} sit twelve metres back, their lamps and lit windows blooming gently out of focus. Open shade on the street lights him evenly from above, with the pavement bouncing a clean fill that keeps his eyes readable head to toe. A 9:16 full-length frame at eye level, Sony A7S III, 35mm, f/2, 1/125, ISO 3200. Spread grain through shadows and background as well as skin, keeping mixed colour temperature and natural highlights.",
    "locations": {
      "urban": "a long open city street",
      "outdoorsy": "a wide small-town main street",
      "homebody": "a quiet residential street"
  ...
  },
  {
    ...
    "tags": [],
    "light": "Open shade on the street lights him evenly from above, with the pavement bouncing a clean fill that keeps his eyes readable head to toe.",
    "promptTemplate": "Use the supplied photographs for identity. Keep his face shape, skin tone, hair, beard pattern, age, and asymmetry exactly as they appear, on him alone. At {{location}}, wearing {{outfit}}. He tugs the front of his jacket straight with one hand and lets it fall. He looks to the lens. Fifteen metres beyond him, {{backdrop}} smear into slow ambient movement. Open shade on the street lights him evenly from above, with the pavement bouncing a clean fill that keeps his eyes readable head to toe. A 9:16 handheld full-length frame from a low natural height, compact 35mm camera, f/4, 1/60, ISO 800, restrained direct flash. Flash reveals honest texture, modest shine, fabric creases, and one natural shadow cast behind him.",
    "locations": {
      "urban": "a long open city street",
      "outdoorsy": "a wide small-town main street",
      "homebody": "a quiet residential street"
  ...
  },
  {
    ...
    "tags": [],
    "light": "Low sun runs straight down the street from behind the camera and lights him fully from the front, laying a long shadow back behind his feet.",
    "promptTemplate": "All references show the same man. Preserve his face, skin tone, hair, beard pattern, age, and natural asymmetry; this identity belongs to him alone. At {{location}}, wearing {{outfit}}. He walks toward the camera with one thumb hooked in a pocket, unhurried. He looks to the lens the whole way. Six metres behind him, {{backdrop}} break into soft discs of practical light. Low sun runs straight down the street from behind the camera and lights him fully from the front, laying a long shadow back behind his feet. A 9:16 full-length street frame with straight surrounding lines, Leica Q2, 28mm, f/2.8, 1/250, auto ISO 800-3200. Retain distance-appropriate facial detail, fabric wear, true reflections, and available-light colour exactly as the street gives it.",
    "locations": {
      "urban": "a long open city street",
      "outdoorsy": "a wide small-town main street",
      "homebody": "a quiet residential street"
    ...
    "backdrops": {
      "urban": "a kerb line, bollards and glass frontages",
      "outdoorsy": "a wide pavement, planters and a low skyline",
  ...
  },
  {
    ...
    "tags": [],
    "light": "Low sun runs straight down the street from behind the camera and lights him fully from the front, laying a long shadow back behind his feet.",
    "promptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. At {{location}}, wearing {{outfit}}. He turns on the spot mid-stride to look back the way he came, one hand out. He finds the lens over his shoulder. The street runs back nine metres to {{backdrop}}, everything past him going soft and warm. Low sun runs straight down the street from behind the camera and lights him fully from the front, laying a long shadow back behind his feet. A 9:16 full-body night photograph with the face still readable, Sony A7S III, 35mm, f/2, 1/125, ISO 3200. Spread grain through shadows and background as well as skin, keeping mixed colour temperature and natural highlights.",
    "locations": {
      "urban": "a long open city street",
      "outdoorsy": "a wide small-town main street",
      "homebody": "a quiet residential street"
  ...
  },
  {
    ...
    "tags": [],
    "light": "Low sun runs straight down the street from behind the camera and lights him fully from the front, laying a long shadow back behind his feet.",
    "promptTemplate": "Use the supplied photographs for identity. Keep his face shape, skin tone, hair, beard pattern, age, and asymmetry exactly as they appear, on him alone. At {{location}}, wearing {{outfit}}. He stands with one foot up on the kerb and a forearm across his knee. He looks off to his left, past the lens. He stands four metres clear of {{backdrop}}, which fall away into grainy shadow and lit edges. Low sun runs straight down the street from behind the camera and lights him fully from the front, laying a long shadow back behind his feet. A 3:4 knee-up flash photograph with a clean shadow behind him, compact 35mm camera, f/4, 1/60, ISO 800, restrained direct flash. Flash reveals honest texture, modest shine, fabric creases, and one natural shadow cast behind him.",
    "locations": {
      "urban": "a long open city street",
      "outdoorsy": "a wide small-town main street",
      "homebody": "a quiet residential street"
  ...
  },
  {
    ...
    "tags": [],
    "light": "Bright sky sits behind him at the end of the street and reads almost white, while his face is carried frontally by light bouncing off the buildings opposite.",
    "promptTemplate": "All references show the same man. Preserve his face, skin tone, hair, beard pattern, age, and natural asymmetry; this identity belongs to him alone. At {{location}}, wearing {{outfit}}. He crosses the empty junction at an easy pace with both hands in his pockets. He glances to the lens as he reaches the far kerb. {{backdrop}} sit twelve metres back, their lamps and lit windows blooming gently out of focus. Bright sky sits behind him at the end of the street and reads almost white, while his face is carried frontally by light bouncing off the buildings opposite. A 9:16 full-length street frame with straight surrounding lines, Leica Q2, 28mm, f/2.8, 1/250, auto ISO 800-3200. Retain distance-appropriate facial detail, fabric wear, true reflections, and available-light colour exactly as the street gives it.",
    "locations": {
      "urban": "a long open city street",
      "outdoorsy": "a wide small-town main street",
      "homebody": "a quiet residential street"
    ...
    "backdrops": {
      "urban": "a crossing, painted lines and tall buildings",
      "outdoorsy": "a main junction, a shopfront and open sky",
  ...
  },
  {
    ...
    "tags": [],
    "light": "Bright sky sits behind him at the end of the street and reads almost white, while his face is carried frontally by light bouncing off the buildings opposite.",
    "promptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. At {{location}}, wearing {{outfit}}. He stops at the kerb and pushes both sleeves back off his wrists. He looks to the lens. Fifteen metres beyond him, {{backdrop}} smear into slow ambient movement. Bright sky sits behind him at the end of the street and reads almost white, while his face is carried frontally by light bouncing off the buildings opposite. A 3:4 waist-up frame from an ordinary kerbside distance, Sony A7S III, 35mm, f/2, 1/125, ISO 3200. Spread grain through shadows and background as well as skin, keeping mixed colour temperature and natural highlights.",
    "locations": {
      "urban": "a long open city street",
      "outdoorsy": "a wide small-town main street",
      "homebody": "a quiet residential street"
  ...
  },
  {
    ...
    "tags": [],
    "light": "Bright sky sits behind him at the end of the street and reads almost white, while his face is carried frontally by light bouncing off the buildings opposite.",
    "promptTemplate": "Use the supplied photographs for identity. Keep his face shape, skin tone, hair, beard pattern, age, and asymmetry exactly as they appear, on him alone. At {{location}}, wearing {{outfit}}. He walks away down the street, one hand raised in a half wave, and looks back once. He finds the lens as he turns. Twenty metres out, {{backdrop}} reduce to shape and glow while the pavement near him stays sharp. Bright sky sits behind him at the end of the street and reads almost white, while his face is carried frontally by light bouncing off the buildings opposite. A 9:16 handheld full-length frame from a low natural height, compact 35mm camera, f/4, 1/60, ISO 800, restrained direct flash. Flash reveals honest texture, modest shine, fabric creases, and one natural shadow cast behind him.",
    "locations": {
      "urban": "a long open city street",
      "outdoorsy": "a wide small-town main street",
      "homebody": "a quiet residential street"
...
/** Slots that offer a hobby alternative, and so how many hobby photos land. */
const HOBBY_SLOT_COUNT = 10;
...
export function assertLibraryComplete(): void {
  const expectedTotal = DATING_BUCKETS.length * SLOTS_PER_BUCKET * 3;
  if (DATING_PROMPTS.length !== expectedTotal) {
    throw new Error(
      `Prompt library has ${DATING_PROMPTS.length} entries; expected ${expectedTotal}`
    );
  }
  ...
  for (const bucket of DATING_BUCKETS) {
    ...
    if (bucketPrompts.length !== SLOTS_PER_BUCKET * 3) {
      throw new Error(
        `Bucket ${bucket} has ${bucketPrompts.length} prompts; expected ${SLOTS_PER_BUCKET * 3}`
      );
    }
  ...
  // A delivery draws one variant per slot, so the number of slots carrying a
  // hobby alternative is exactly how many hobby photos a user receives. Four
  // slots meant the question he answered changed four photos out of a hundred.
  const hobbySlots = new Set(
    DATING_PROMPTS.filter(
      (p): p is typeof p & { hobbyPromptTemplate: string } =>
        "hobbyPromptTemplate" in p && Boolean(p.hobbyPromptTemplate)
    ).map((p) => `${p.bucket}-${p.slot}`)
  );
  if (hobbySlots.size !== HOBBY_SLOT_COUNT) {
    throw new Error(
      `Library has hobby alternatives on ${hobbySlots.size} slots; expected ${HOBBY_SLOT_COUNT}`
    );
  }
  if (hobbyPromptCount !== HOBBY_SLOT_COUNT * 3) {
    throw new Error(
      `Prompt library has ${hobbyPromptCount} hobby alternatives; expected ${HOBBY_SLOT_COUNT * 3}`
    );
  }

  assertDepictedInterestsAreReal();
}

/**
 * Every value in a `depicts` array must be an interest a user can actually tap.
 *
 * The mirror of the tag rule: a tag nothing can filter on is decoration, and an
 * interest nothing can select is worse — it silently claims a scene serves an
 * answer no one can give. A typo here would fail closed and quietly, because
 * selection simply never matches it.
 */
function assertDepictedInterestsAreReal(): void {
  const valid = new Set<string>(INTEREST_IDS);
  for (const prompt of DATING_PROMPTS) {
    // `as const` gives every entry its own literal type, and only some carry the
    // optional field, so it needs `in` narrowing rather than a plain access.
    const depicts =
      "depicts" in prompt ? (prompt.depicts as readonly string[]) : [];
    for (const id of depicts) {
      if (!valid.has(id)) {
        throw new Error(
          `Prompt ${prompt.id} says it depicts "${id}", which is not an interest a user can choose`
        );
      }
    }
  }
