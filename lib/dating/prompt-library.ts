...
export const DATING_PROMPTS = [
  ...
  },
  {
    ...
    "light": "Soft light arrives from the left at head height and models that side of his face, with the far cheek holding detail on ambient fill.",
    "promptTemplate": "Use the supplied photographs for identity. Keep his face shape, skin tone, hair, beard pattern, age, and asymmetry exactly as they appear, on him alone. At {{location}}, wearing {{outfit}}. He shifts toward the daylight with one hand still on the doorframe. He answers the photographer and looks off to his left as he finishes the thought, expression open. Behind him at eight metres, {{backdrop}} melt into haze. Soft light arrives from the left at head height and models that side of his face, with the far cheek holding detail on ambient fill. A 3:4 knee-up frame from a natural conversational distance, friend-taken iPhone 15 Pro at 48mm equivalent, standard photo mode. Show distance-appropriate facial detail, flyaway hairs, and fabric creases, letting the lens render depth on its own.",
    "locations": {
      "urban": "a pale-stone city colonnade",
      "outdoorsy": "a shaded park pavilion",
      "homebody": "a bright apartment balcony doorway"
  ...
  },
  {
    ...
    "light": "Bright sky sits behind him and reads much lighter than he does, so his face rides on the soft bounce coming back off the pale surface in front.",
    "promptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. At {{location}}, wearing {{outfit}}. He finishes fastening one cuff and lowers both hands. A follow-up question catches him and he gives the photographer an easy half-smile straight into the lens. The scene opens back seven metres to {{backdrop}}, held in soft focus. Bright sky sits behind him and reads much lighter than he does, so his face rides on the soft bounce coming back off the pale surface in front. A 4:3 wide environmental frame at eye level with him set left of centre, Canon R5, 85mm, f/2, 1/320, ISO 400. Keep real skin microtexture, grooming irregularities, soft highlight rolloff, and believable focus falloff, with pores and fine lines intact.",
    "locations": {
      "urban": "a pale-stone city colonnade",
      "outdoorsy": "a shaded park pavilion",
      "homebody": "a bright apartment balcony doorway"
  ...
  },
  {
    ...
    "promptTemplate": "All references show the same man. Preserve his face, skin tone, hair, beard pattern, age, and natural asymmetry; this identity belongs to him alone. At {{location}}, wearing {{outfit}}. He adjusts the cuff of his sleeve after sitting down, hands still working as he speaks. He looks up into the lens while the photographer is still talking. Four metres behind him, {{backdrop}} settle into soft graded tone. Daylight comes from above and slightly ahead, catching his brow and the tops of his shoulders while the underside of his jaw falls into shadow. A 3:4 waist-up frame at seated eye level, Fujifilm GFX 100S, 80mm, f/2.8, 1/250, ISO 200. Retain tonal variation, faint under-eye texture, varied beard density, and natural highlights, with skin that keeps its own grain.",
    "locations": {
      "urban": "a quiet design café window",
      "outdoorsy": "a lodge reading corner",
      "homebody": "a tidy living-room window"
  ...
  },
  {
    ...
    "light": "Daylight comes from above and slightly ahead, catching his brow and the tops of his shoulders while the underside of his jaw falls into shadow.",
    "promptTemplate": "Use the supplied photographs for identity. Keep his face shape, skin tone, hair, beard pattern, age, and asymmetry exactly as they appear, on him alone. At {{location}}, wearing {{outfit}}. He steps away from the window, smooths the front of his jacket once with a flat hand, and turns to the lens when the photographer calls to him, weight still on his back foot. Seven metres of room open up behind him to {{backdrop}}, all softly out of focus. Daylight comes from above and slightly ahead, catching his brow and the tops of his shoulders while the underside of his jaw falls into shadow. A 9:16 friend-taken full-length frame from a low natural height, friend-taken iPhone 15 Pro at 48mm equivalent, standard photo mode. Show distance-appropriate facial detail, flyaway hairs, and fabric creases, letting the lens render depth on its own.",
    "locations": {
      "urban": "a quiet design café window",
      "outdoorsy": "a lodge reading corner",
      "homebody": "a tidy living-room window"
  ...
  },
  {
    ...
    "light": "A wide bright opening ahead of him lights his face frontally and softly, with the darker interior behind him holding its own deep shadow.",
    "promptTemplate": "Use the supplied photographs for identity. Keep his face shape, skin tone, hair, beard pattern, age, and asymmetry exactly as they appear, on him alone. At {{location}}, wearing {{outfit}}. He slows at the corner with one hand on a chair back to let the way clear. He gives the photographer an amused side glance from the corner of his eye. Six metres beyond him, {{backdrop}} sit fully soft. A wide bright opening ahead of him lights his face frontally and softly, with the darker interior behind him holding its own deep shadow. A 3:4 friend-taken chest-up portrait with casual headroom, friend-taken iPhone 15 Pro at 48mm equivalent, standard photo mode. Show distance-appropriate facial detail, flyaway hairs, and fabric creases, letting the lens render depth on its own.",
    "locations": {
      "urban": "a quiet design café window",
      "outdoorsy": "a lodge reading corner",
      "homebody": "a tidy living-room window"
  ...
  },
  {
    ...
    "light": "Late sun comes low from his left and lays warm directional light across his face, with the wall opposite bouncing a weaker fill into the shadow side.",
    "promptTemplate": "Use the supplied photographs for identity. Keep his face shape, skin tone, hair, beard pattern, age, and asymmetry exactly as they appear, on him alone. At {{location}}, wearing {{outfit}}. One shoulder rests on the wall with a phone loose in the near hand. He listens with his head slightly turned toward the photographer, then smiles into the lens while his stance stays relaxed. Four metres out, {{backdrop}} recede into an unremarkable soft field. Late sun comes low from his left and lays warm directional light across his face, with the wall opposite bouncing a weaker fill into the shadow side. A 3:4 friend-taken medium portrait with slightly imperfect but intentional framing, friend-taken iPhone 15 Pro at 48mm equivalent, standard photo mode. Show distance-appropriate facial detail, flyaway hairs, and fabric creases, letting the lens render depth on its own.",
    "locations": {
      "urban": "a warm brick side-street wall",
      "outdoorsy": "a weathered visitor-center wall",
      "homebody": "a simple home courtyard wall"
  ...
  },
  {
    ...
    "light": "Even overcast light reaches him from the whole sky above, giving soft modelling and a quiet shadow beneath his chin.",
    "promptTemplate": "Use the supplied photographs for identity. Keep his face shape, skin tone, hair, beard pattern, age, and asymmetry exactly as they appear, on him alone. At {{location}}, wearing {{outfit}}. His forearms rest loosely on his thighs with fingers laced. A quiet joke from the photographer pulls a laugh and he looks straight into the lens through it. Four metres back, {{backdrop}} carry gentle blur and a little ambient colour. Even overcast light reaches him from the whole sky above, giving soft modelling and a quiet shadow beneath his chin. A 3:4 friend-taken waist-up portrait from slightly above, friend-taken iPhone 15 Pro at 48mm equivalent, standard photo mode. Show distance-appropriate facial detail, flyaway hairs, and fabric creases, letting the lens render depth on its own.",
    "locations": {
      "urban": "a warm brick side-street wall",
      "outdoorsy": "a weathered visitor-center wall",
      "homebody": "a simple home courtyard wall"
  ...
  },
  {
    ...
    "light": "Light from a tall opening behind his shoulder rims his hair, while the pale floor in front throws a softer light up onto his face a stop under it.",
    "promptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. At {{location}}, wearing {{outfit}}. He rests one hand on a ledge and turns his shoulders back toward the camera. He replies to something the photographer has just said, eyes on the lens. Five metres behind him, {{backdrop}} render soft with clean highlight shapes. Light from a tall opening behind his shoulder rims his hair, while the pale floor in front throws a softer light up onto his face a stop under it. A 3:4 chest-up frame at eye level, Canon R5, 85mm, f/2, 1/320, ISO 400. Keep real skin microtexture, grooming irregularities, soft highlight rolloff, and believable focus falloff, with pores and fine lines intact.",
    "locations": {
      "urban": "a modern museum courtyard",
      "outdoorsy": "a botanical-garden path",
      "homebody": "a covered residential stoop"
  ...
  },
  {
    ...
    "light": "Daylight arrives from ahead and above at forty-five degrees, modelling his brow, nose and jaw with short controlled shadows.",
    "promptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. At {{location}}, wearing {{outfit}}. He steps out with both hands loose, hears the photographer behind him, and rotates only enough to reconnect, eyes finding the lens. Six metres behind him, {{backdrop}} lose their edges. Daylight arrives from ahead and above at forty-five degrees, modelling his brow, nose and jaw with short controlled shadows. A 3:4 waist-up frame from a three-quarter angle, Canon R5, 85mm, f/2, 1/320, ISO 400. Keep real skin microtexture, grooming irregularities, soft highlight rolloff, and believable focus falloff, with pores and fine lines intact.",
    "locations": {
      "urban": "a modern museum courtyard",
      "outdoorsy": "a botanical-garden path",
      "homebody": "a covered residential stoop"
  ...
  },
  {
    ...
    "light": "Light from a wide window sits directly to his side and splits his face cleanly, one half bright and the other holding on room bounce.",
    "promptTemplate": "Use the supplied photographs for identity. Keep his face shape, skin tone, hair, beard pattern, age, and asymmetry exactly as they appear, on him alone. At {{location}}, wearing {{outfit}}. He sits back with one hand around a mug and looks over his shoulder into the lens when the photographer asks what he can see. Five metres back, {{backdrop}} sit soft and warm. Light from a wide window sits directly to his side and splits his face cleanly, one half bright and the other holding on room bounce. A 3:4 friend-taken chest-up portrait with casual headroom, friend-taken iPhone 15 Pro at 48mm equivalent, standard photo mode. Show distance-appropriate facial detail, flyaway hairs, and fabric creases, letting the lens render depth on its own.",
    "locations": {
      "urban": "a quiet city coffee-bar window",
      "outdoorsy": "a mountain-town bakery window",
      "homebody": "a sunlit kitchen breakfast nook"
  ...
  },
  {
    ...
    "light": "Soft daylight comes from the front over the photographer's shoulder and lands evenly on him, with the depth behind falling a stop or more darker.",
    "promptTemplate": "All references show the same man. Preserve his face, skin tone, hair, beard pattern, age, and natural asymmetry; this identity belongs to him alone. At {{location}}, wearing {{outfit}}. He has just greeted the photographer and brings his hands loosely together after the handshake, keeping a warm direct gaze on the lens. Four metres behind him, {{backdrop}} sit softly out of focus. Soft daylight comes from the front over the photographer's shoulder and lands evenly on him, with the depth behind falling a stop or more darker. A 3:4 chest-up frame at eye level, Fujifilm GFX 100S, 80mm, f/2.8, 1/250, ISO 200. Retain tonal variation, faint under-eye texture, varied beard density, and natural highlights, with skin that keeps its own grain.",
    "locations": {
      "urban": "a quiet city coffee-bar window",
      "outdoorsy": "a mountain-town bakery window",
      "homebody": "a sunlit kitchen breakfast nook"
  ...
  },
  {
    ...
    "light": "Soft daylight comes from the front over the photographer's shoulder and lands evenly on him, with the depth behind falling a stop or more darker.",
    "promptTemplate": "Use the supplied photographs for identity. Keep his face shape, skin tone, hair, beard pattern, age, and asymmetry exactly as they appear, on him alone. At {{location}}, wearing {{outfit}}. He steps out of the doorway with a paper bag in one hand, recognises the photographer, and smiles into the lens as he keeps walking toward them. Eight metres behind him, {{backdrop}} compress into soft street light. Soft daylight comes from the front over the photographer's shoulder and lands evenly on him, with the depth behind falling a stop or more darker. A 9:16 friend-taken full-length frame from a low natural height, friend-taken iPhone 15 Pro at 48mm equivalent, standard photo mode. Show distance-appropriate facial detail, flyaway hairs, and fabric creases, letting the lens render depth on its own.",
    "locations": {
      "urban": "a quiet city coffee-bar window",
      "outdoorsy": "a mountain-town bakery window",
      "homebody": "a sunlit kitchen breakfast nook"
  ...
  },
  {
    ...
    "promptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. At {{location}}, wearing {{outfit}}. He pulls a chair out with one hand and stays half standing to greet the arrival. The smile arrives as he glances back to the lens. A freckled red-haired man in his thirties cups a mug and looks toward the doorway, and a short woman with a blunt black bob is half standing to point at something outside. The others are gathered a couple of metres past him, and {{backdrop}} drop off five metres behind them. A warm bulb over the service door sits behind his left shoulder and rims his hair and jaw, while the pale table top bounces just enough back up to open his face a stop under that rim. A modest direct flash from the camera adds a half stop of fill across his face and lays one soft shadow behind him. A 3:4 knee-up flash photograph with easy space around him, Fujifilm X100V, 23mm, f/4, 1/125, ISO 800. Flash reveals honest texture, modest shine at the forehead, fabric creases, and the weave of the table top.",
    "locations": {
      "urban": "a lively city bistro terrace",
      "outdoorsy": "a lodge restaurant deck",
      "homebody": "a neighborhood dinner patio"
  ...
  },
  {
    ...
    "light": "Strung bulbs run above and slightly ahead of him, dropping soft overlapping pools onto his forehead and forearms and leaving the underside of his chin in shadow.",
    "promptTemplate": "Use the supplied photographs for identity. Keep his face shape, skin tone, hair, beard pattern, age, and asymmetry exactly as they appear, on him alone. At {{location}}, wearing {{outfit}}. He sets one drink beside his plate and laughs, both hands still on the table. His eyes go to his left, past the lens, to whoever caused it. Two men are at the table with him: a broad bald man in his fifties with a grey beard, laughing at something in his own hands, and a slim man in his twenties with straight light-brown hair, turned away toward the room. He is nearest the camera with the others further along the same side, and {{backdrop}} fall away eight metres behind into soft shape. Strung bulbs run above and slightly ahead of him, dropping soft overlapping pools onto his forehead and forearms and leaving the underside of his chin in shadow. A 4:3 three-quarter candid at seated height, friend-taken iPhone 15 Pro at 35mm equivalent, standard photo mode. Preserve distance-appropriate facial detail, slight gesture motion, and ordinary phone texture with true venue colour.",
    "locations": {
      "urban": "a lively city bistro terrace",
      "outdoorsy": "a lodge restaurant deck",
      "homebody": "a neighborhood dinner patio"
  ...
  },
  {
    ...
    "promptTemplate": "All references show the same man. Preserve his face, skin tone, hair, beard pattern, age, and natural asymmetry; this identity belongs to him alone. At {{location}}, wearing {{outfit}}. He rests one forearm on the counter while a story finishes beside him. He turns to the lens with the residual smile still there. A freckled red-haired man in his thirties cups a mug and looks toward the doorway, and a short woman with a blunt black bob is half standing to point at something outside. The others are gathered a couple of metres past him, and {{backdrop}} drop off five metres behind them. Low afternoon sun comes across the terrace from his right, raking one side of his face into clear relief while the shaded side holds detail on bounce off the render behind him. A 3:4 chest-up frame through a little foreground context, Sony A7S III, 35mm, f/2, 1/160, ISO 3200. Retain distance-appropriate facial detail, warm venue colour across his skin, fabric folds, and grain carried through shadow and background alike.",
    "locations": {
  ...
  },
  {
    ...
    "light": "Low afternoon sun comes across the terrace from his right, raking one side of his face into clear relief while the shaded side holds detail on bounce off the render behind him.",
    "promptTemplate": "Use the supplied photographs for identity. Keep his face shape, skin tone, hair, beard pattern, age, and asymmetry exactly as they appear, on him alone. At {{location}}, wearing {{outfit}}. He steps away from the counter with a cup in each hand to rejoin the table. He reacts to a comment, eyes on the lens before he arrives. Two women he knows are with him: an older one with silver-streaked hair pinned up, mid-sentence with a hand raised, and a younger one with tight coiled curls, looking down at her plate. The group is strung out from the near corner into the room, with {{backdrop}} six metres back and well out of focus. Low afternoon sun comes across the terrace from his right, raking one side of his face into clear relief while the shaded side holds detail on bounce off the render behind him. A 3:4 chest-up candid with one soft foreground shoulder, friend-taken iPhone 15 Pro at 35mm equivalent, standard photo mode. Preserve distance-appropriate facial detail, slight gesture motion, and ordinary phone texture with true venue colour.",
    "locations": {
      "urban": "a sidewalk coffee patio",
      "outdoorsy": "a trail-town café terrace",
      "homebody": "a local bakery patio"
  ...
  },
  {
    ...
    "promptTemplate": "All references show the same man. Preserve his face, skin tone, hair, beard pattern, age, and natural asymmetry; this identity belongs to him alone. At {{location}}, wearing {{outfit}}. He gestures with one hand while speaking and keeps a glass low in the other. His eye contact stays just past the lens. An older man in a flat cap with deep smile lines cuts bread with both hands, and a wiry man in his twenties with dark curls and a hoop earring leans in to hear over the noise. The company sits opposite and slightly behind him, with {{backdrop}} ten metres back going soft. Warm light spills from the doorway behind the camera and lands flat across his face, while the darker depth behind him keeps the room's own shadows intact. A 4:3 waist-up documentary frame from across the table, Sony A7S III, 35mm, f/2, 1/160, ISO 3200. Retain distance-appropriate facial detail, warm venue colour across his skin, fabric folds, and grain carried through shadow and background alike.",
    "locations": {
      "urban": "a sidewalk coffee patio",
      "outdoorsy": "a trail-town café terrace",
      "homebody": "a local bakery patio"
  ...
  },
  {
    ...
    "promptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. At {{location}}, wearing {{outfit}}. He finishes explaining something and lowers both hands to the table as the answers come back. He turns to the lens in the pause. Two women he knows are with him: an older one with silver-streaked hair pinned up, mid-sentence with a hand raised, and a younger one with tight coiled curls, looking down at her plate. The group is strung out from the near corner into the room, with {{backdrop}} six metres back and well out of focus. Warm light spills from the doorway behind the camera and lands flat across his face, while the darker depth behind him keeps the room's own shadows intact. A modest direct flash from the camera adds a half stop of fill across his face and lays one soft shadow behind him. A 3:4 chest-up frame from a neighbouring seat, Fujifilm X100V, 23mm, f/4, 1/125, ISO 800. Flash reveals honest texture, modest shine at the forehead, fabric creases, and the weave of the table top.",
    "locations": {
      "urban": "a sidewalk coffee patio",
      "outdoorsy": "a trail-town café terrace",
      "homebody": "a local bakery patio"
  ...
  },
  {
    ...
    "light": "Warm light spills from the doorway behind the camera and lands flat across his face, while the darker depth behind him keeps the room's own shadows intact.",
    "promptTemplate": "Use the supplied photographs for identity. Keep his face shape, skin tone, hair, beard pattern, age, and asymmetry exactly as they appear, on him alone. At {{location}}, wearing {{outfit}}. He turns from one side of the table to the other mid-story, one hand raised a little. The engaged expression catches the lens between sentences. A freckled red-haired man in his thirties cups a mug and looks toward the doorway, and a short woman with a blunt black bob is half standing to point at something outside. The others are gathered a couple of metres past him, and {{backdrop}} drop off five metres behind them. Warm light spills from the doorway behind the camera and lands flat across his face, while the darker depth behind him keeps the room's own shadows intact. A 4:3 friend-taken medium shot from conversational distance, friend-taken iPhone 15 Pro at 35mm equivalent, standard photo mode. Preserve distance-appropriate facial detail, slight gesture motion, and ordinary phone texture with true venue colour.",
    "locations": {
      "urban": "a sidewalk coffee patio",
      "outdoorsy": "a trail-town café terrace",
      "homebody": "a local bakery patio"
  ...
  },
  {
    ...
    "promptTemplate": "All references show the same man. Preserve his face, skin tone, hair, beard pattern, age, and natural asymmetry; this identity belongs to him alone. At {{location}}, wearing {{outfit}}. He stands from the table with one hand on its edge to greet an arrival. He looks back to the lens as his name is called after him. Two men are at the table with him: a broad bald man in his fifties with a grey beard, laughing at something in his own hands, and a slim man in his twenties with straight light-brown hair, turned away toward the room. He is nearest the camera with the others further along the same side, and {{backdrop}} fall away eight metres behind into soft shape. Candles and low table lamps sit below his eyeline and light him from underneath at close range, catching the underside of his brow and the bridge of his nose. A 4:3 medium frame from the edge of the conversation, Sony A7S III, 35mm, f/2, 1/160, ISO 3200. Retain distance-appropriate facial detail, warm venue colour across his skin, fabric folds, and grain carried through shadow and background alike.",
    "locations": {
  ...
  },
  {
    ...
    "promptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. At {{location}}, wearing {{outfit}}. He comes back carrying one small plate, steadying it with both hands. He smiles toward the lens as he reaches the table. A heavy man in his sixties with a white moustache turns a bottle in both hands at the far corner, while a tall thin man with a shaved head and glasses reaches past him for a jug. He holds the near ground and the others sit deeper into the frame, with {{backdrop}} seven metres beyond in soft light. Candles and low table lamps sit below his eyeline and light him from underneath at close range, catching the underside of his brow and the bridge of his nose. A modest direct flash from the camera adds a half stop of fill across his face and lays one soft shadow behind him. A 3:4 knee-up flash photograph with easy space around him, Fujifilm X100V, 23mm, f/4, 1/125, ISO 800. Flash reveals honest texture, modest shine at the forehead, fabric creases, and the weave of the table top.",
    "locations": {
      "urban": "a rooftop dinner table",
      "outdoorsy": "a lakeside restaurant deck",
      "homebody": "a backyard supper table"
  ...
  },
  {
    ...
    "light": "Candles and low table lamps sit below his eyeline and light him from underneath at close range, catching the underside of his brow and the bridge of his nose.",
    "promptTemplate": "Use the supplied photographs for identity. Keep his face shape, skin tone, hair, beard pattern, age, and asymmetry exactly as they appear, on him alone. At {{location}}, wearing {{outfit}}. He holds a door with one hand and steps through after the others. He reacts to something said behind him, eyes off to the left of the lens. A stocky man in his forties with close-cropped grey hair leans back with folded arms, watching the room, and a young woman with long straight blonde hair beside him is writing on her hand. He is closest to the lens with the rest of the party trailing back, and {{backdrop}} dissolve nine metres further off. Candles and low table lamps sit below his eyeline and light him from underneath at close range, catching the underside of his brow and the bridge of his nose. A 4:3 waist-up snapshot with the venue still readable, friend-taken iPhone 15 Pro at 35mm equivalent, standard photo mode. Preserve distance-appropriate facial detail, slight gesture motion, and ordinary phone texture with true venue colour.",
    "locations": {
      "urban": "a rooftop dinner table",
      "outdoorsy": "a lakeside restaurant deck",
      "homebody": "a backyard supper table"
  ...
  },
  {
    ...
    "promptTemplate": "All references show the same man. Preserve his face, skin tone, hair, beard pattern, age, and natural asymmetry; this identity belongs to him alone. At {{location}}, wearing {{outfit}}. He settles into his seat after making room, one hand along the chair back. He smiles across the table into the lens. Two women he knows are with him: an older one with silver-streaked hair pinned up, mid-sentence with a hand raised, and a younger one with tight coiled curls, looking down at her plate. The group is strung out from the near corner into the room, with {{backdrop}} six metres back and well out of focus. A single pendant hangs over the middle of the table between him and the camera, so his near side is bright and his far cheek falls off into the room's shadow. A 4:3 three-quarter frame at seated height, Sony A7S III, 35mm, f/2, 1/160, ISO 3200. Retain distance-appropriate facial detail, warm venue colour across his skin, fabric folds, and grain carried through shadow and background alike.",
    "locations": {
      "urban": "a rooftop dinner table",
      "outdoorsy": "a lakeside restaurant deck",
      "homebody": "a backyard supper table"
  ...
  },
  {
    ...
    "light": "A single pendant hangs over the middle of the table between him and the camera, so his near side is bright and his far cheek falls off into the room's shadow.",
    "promptTemplate": "Use the supplied photographs for identity. Keep his face shape, skin tone, hair, beard pattern, age, and asymmetry exactly as they appear, on him alone. At {{location}}, wearing {{outfit}}. He slides a plate across with one hand and leans back as his recommendation is argued with. The laugh goes to his right, past the lens. An older man in a flat cap with deep smile lines cuts bread with both hands, and a wiry man in his twenties with dark curls and a hoop earring leans in to hear over the noise. The company sits opposite and slightly behind him, with {{backdrop}} ten metres back going soft. A single pendant hangs over the middle of the table between him and the camera, so his near side is bright and his far cheek falls off into the room's shadow. A 4:3 three-quarter candid at seated height, friend-taken iPhone 15 Pro at 35mm equivalent, standard photo mode. Preserve distance-appropriate facial detail, slight gesture motion, and ordinary phone texture with true venue colour.",
    "locations": {
      "urban": "a rooftop dinner table",
      "outdoorsy": "a lakeside restaurant deck",
      "homebody": "a backyard supper table"
  ...
  },
  {
    ...
    "promptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. At {{location}}, wearing {{outfit}}. He carries two cups carefully, one in each hand, and spots the table. He smiles at the lens before setting them down. A stocky man in his forties with close-cropped grey hair leans back with folded arms, watching the room, and a young woman with long straight blonde hair beside him is writing on her hand. He is closest to the lens with the rest of the party trailing back, and {{backdrop}} dissolve nine metres further off. The last blue of the sky sits behind him and reads cool on his shoulders, while a warm heater element to his left carries the actual light on his face. A modest direct flash from the camera adds a half stop of fill across his face and lays one soft shadow behind him. A 4:3 medium photograph with hands and table objects fully supported, Fujifilm X100V, 23mm, f/4, 1/125, ISO 800. Flash reveals honest texture, modest shine at the forehead, fabric creases, and the weave of the table top.",
    "locations": {
      "urban": "a rooftop dinner table",
      "outdoorsy": "a lakeside restaurant deck",
      "homebody": "a backyard supper table"
  ...
  },
  {
    ...
    "light": "The last blue of the sky sits behind him and reads cool on his shoulders, while a warm heater element to his left carries the actual light on his face.",
    "promptTemplate": "Use the supplied photographs for identity. Keep his face shape, skin tone, hair, beard pattern, age, and asymmetry exactly as they appear, on him alone. At {{location}}, wearing {{outfit}}. He steps around an occupied chair, one hand out for balance, still talking. His attention stays beside him, off to the left of the lens. Two men are at the table with him: a broad bald man in his fifties with a grey beard, laughing at something in his own hands, and a slim man in his twenties with straight light-brown hair, turned away toward the room. He is nearest the camera with the others further along the same side, and {{backdrop}} fall away eight metres behind into soft shape. The last blue of the sky sits behind him and reads cool on his shoulders, while a warm heater element to his left carries the actual light on his face. A 3:4 chest-up candid with one soft foreground shoulder, friend-taken iPhone 15 Pro at 35mm equivalent, standard photo mode. Preserve distance-appropriate facial detail, slight gesture motion, and ordinary phone texture with true venue colour.",
    "locations": {
      "urban": "a rooftop dinner table",
      "outdoorsy": "a lakeside restaurant deck",
      "homebody": "a backyard supper table"
  ...
  },
  {
    ...
    "promptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. At {{location}}, wearing {{outfit}}. He reaches across to return a bottle opener and draws his hand back. He smiles toward the lens as he settles again. An older man in a flat cap with deep smile lines cuts bread with both hands, and a wiry man in his twenties with dark curls and a hoop earring leans in to hear over the noise. The company sits opposite and slightly behind him, with {{backdrop}} ten metres back going soft. Backlit bottles behind the bar throw a warm halo through his hair from behind, and the bar top bounces a soft, weaker light back onto his chin and cheeks. A modest direct flash from the camera adds a half stop of fill across his face and lays one soft shadow behind him. A 9:16 full-body flash photograph with room at the edges, Fujifilm X100V, 23mm, f/4, 1/125, ISO 800. Flash reveals honest texture, modest shine at the forehead, fabric creases, and the weave of the table top.",
    "locations": {
      "urban": "a restrained cocktail lounge",
      "outdoorsy": "a lodge common-room bar",
      "homebody": "a neighborhood pub counter"
  ...
  },
  {
    ...
    "light": "Backlit bottles behind the bar throw a warm halo through his hair from behind, and the bar top bounces a soft, weaker light back onto his chin and cheeks.",
    "promptTemplate": "Use the supplied photographs for identity. Keep his face shape, skin tone, hair, beard pattern, age, and asymmetry exactly as they appear, on him alone. At {{location}}, wearing {{outfit}}. He stands at the bar with one elbow on it, a glass in the other hand. He reacts with a soft real laugh, eyes on the lens. Two women he knows are with him: an older one with silver-streaked hair pinned up, mid-sentence with a hand raised, and a younger one with tight coiled curls, looking down at her plate. The group is strung out from the near corner into the room, with {{backdrop}} six metres back and well out of focus. Backlit bottles behind the bar throw a warm halo through his hair from behind, and the bar top bounces a soft, weaker light back onto his chin and cheeks. A 9:16 full-body candid that keeps ordinary movement, friend-taken iPhone 15 Pro at 35mm equivalent, standard photo mode. Preserve distance-appropriate facial detail, slight gesture motion, and ordinary phone texture with true venue colour.",
    "locations": {
      "urban": "a restrained cocktail lounge",
      "outdoorsy": "a lodge common-room bar",
      "homebody": "a neighborhood pub counter"
  ...
  },
  {
    ...
    "promptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. At {{location}}, wearing {{outfit}}. He joins the edge of a conversation, both hands loose in front of him. He smiles to the lens before adding his own line. Two men are at the table with him: a broad bald man in his fifties with a grey beard, laughing at something in his own hands, and a slim man in his twenties with straight light-brown hair, turned away toward the room. He is nearest the camera with the others further along the same side, and {{backdrop}} fall away eight metres behind into soft shape. A shaded lamp on the wall to his right lights him from the side at head height, leaving a clean falloff across his nose onto the far cheek. A modest direct flash from the camera adds a half stop of fill across his face and lays one soft shadow behind him. A 3:4 chest-up frame from a neighbouring seat, Fujifilm X100V, 23mm, f/4, 1/125, ISO 800. Flash reveals honest texture, modest shine at the forehead, fabric creases, and the weave of the table top.",
    "locations": {
      "urban": "a restrained cocktail lounge",
      "outdoorsy": "a lodge common-room bar",
      "homebody": "a neighborhood pub counter"
  ...
  },
  {
    ...
    "light": "A shaded lamp on the wall to his right lights him from the side at head height, leaving a clean falloff across his nose onto the far cheek.",
    "promptTemplate": "Use the supplied photographs for identity. Keep his face shape, skin tone, hair, beard pattern, age, and asymmetry exactly as they appear, on him alone. At {{location}}, wearing {{outfit}}. He turns his stool toward the group, one hand flat on the counter. He listens with an amused expression, eyes off to the right of the lens. A heavy man in his sixties with a white moustache turns a bottle in both hands at the far corner, while a tall thin man with a shaved head and glasses reaches past him for a jug. He holds the near ground and the others sit deeper into the frame, with {{backdrop}} seven metres beyond in soft light. A shaded lamp on the wall to his right lights him from the side at head height, leaving a clean falloff across his nose onto the far cheek. A 4:3 friend-taken medium shot from conversational distance, friend-taken iPhone 15 Pro at 35mm equivalent, standard photo mode. Preserve distance-appropriate facial detail, slight gesture motion, and ordinary phone texture with true venue colour.",
    "locations": {
      "urban": "a restrained cocktail lounge",
      "outdoorsy": "a lodge common-room bar",
      "homebody": "a neighborhood pub counter"
  ...
  },
  {
    ...
    "promptTemplate": "All references show the same man. Preserve his face, skin tone, hair, beard pattern, age, and natural asymmetry; this identity belongs to him alone. At {{location}}, wearing {{outfit}}. He reaches for a paper cup and pauses with his hand on it when a question comes. He looks up to the lens with an interested smile. Two women he knows are with him: an older one with silver-streaked hair pinned up, mid-sentence with a hand raised, and a younger one with tight coiled curls, looking down at her plate. The group is strung out from the near corner into the room, with {{backdrop}} six metres back and well out of focus. An overcast sky lights the bench evenly from above with a slight lean from the left, and the light stone underfoot lifts a soft fill into his eye sockets. A 3:4 chest-up frame through a little foreground context, Sony A7S III, 35mm, f/2, 1/160, ISO 3200. Retain distance-appropriate facial detail, warm venue colour across his skin, fabric folds, and grain carried through shadow and background alike.",
    "locations": {
      "urban": "an urban park café bench",
      "outdoorsy": "a scenic picnic overlook bench",
      "homebody": "a shared courtyard bench"
  ...
  },
  {
    ...
    "promptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. At {{location}}, wearing {{outfit}}. He passes a bag of pastries across and keeps one hand on the bench. He listens to the answer with his eyes on the lens. A freckled red-haired man in his thirties cups a mug and looks toward the doorway, and a short woman with a blunt black bob is half standing to point at something outside. The others are gathered a couple of metres past him, and {{backdrop}} drop off five metres behind them. An overcast sky lights the bench evenly from above with a slight lean from the left, and the light stone underfoot lifts a soft fill into his eye sockets. A modest direct flash from the camera adds a half stop of fill across his face and lays one soft shadow behind him. A 4:3 medium photograph with hands and table objects fully supported, Fujifilm X100V, 23mm, f/4, 1/125, ISO 800. Flash reveals honest texture, modest shine at the forehead, fabric creases, and the weave of the table top.",
    "locations": {
      "urban": "an urban park café bench",
      "outdoorsy": "a scenic picnic overlook bench",
      "homebody": "a shared courtyard bench"
  ...
  },
  {
    ...
    "light": "An overcast sky lights the bench evenly from above with a slight lean from the left, and the light stone underfoot lifts a soft fill into his eye sockets.",
    "promptTemplate": "Use the supplied photographs for identity. Keep his face shape, skin tone, hair, beard pattern, age, and asymmetry exactly as they appear, on him alone. At {{location}}, wearing {{outfit}}. He folds a paper bag closed, sets it aside, and brushes crumbs from his palm. He rejoins the conversation, eyes to the lens. An older man in a flat cap with deep smile lines cuts bread with both hands, and a wiry man in his twenties with dark curls and a hoop earring leans in to hear over the noise. The company sits opposite and slightly behind him, with {{backdrop}} ten metres back going soft. An overcast sky lights the bench evenly from above with a slight lean from the left, and the light stone underfoot lifts a soft fill into his eye sockets. A 3:4 chest-up candid with one soft foreground shoulder, friend-taken iPhone 15 Pro at 35mm equivalent, standard photo mode. Preserve distance-appropriate facial detail, slight gesture motion, and ordinary phone texture with true venue colour.",
    "locations": {
      "urban": "an urban park café bench",
      "outdoorsy": "a scenic picnic overlook bench",
      "homebody": "a shared courtyard bench"
  ...
  },
  {
    ...
    "light": "Low golden light comes almost level from behind the far side of the square, rimming his hair and the edge of his ear, with his face carried on the warm bounce off the wall opposite.",
    "promptTemplate": "Use the supplied photographs for identity. Keep his face shape, skin tone, hair, beard pattern, age, and asymmetry exactly as they appear, on him alone. At {{location}}, wearing {{outfit}}. He arrives, places his phone face down beside him, and rests both hands on his knees. He smiles to the lens as the group brings him in. Two men are at the table with him: a broad bald man in his fifties with a grey beard, laughing at something in his own hands, and a slim man in his twenties with straight light-brown hair, turned away toward the room. He is nearest the camera with the others further along the same side, and {{backdrop}} fall away eight metres behind into soft shape. Low golden light comes almost level from behind the far side of the square, rimming his hair and the edge of his ear, with his face carried on the warm bounce off the wall opposite. A 9:16 full-body candid that keeps ordinary movement, friend-taken iPhone 15 Pro at 35mm equivalent, standard photo mode. Preserve distance-appropriate facial detail, slight gesture motion, and ordinary phone texture with true venue colour.",
    "locations": {
      "urban": "an urban park café bench",
      "outdoorsy": "a scenic picnic overlook bench",
      "homebody": "a shared courtyard bench"
  ...
  },
  {
    ...
    "promptTemplate": "All references show the same man. Preserve his face, skin tone, hair, beard pattern, age, and natural asymmetry; this identity belongs to him alone. At {{location}}, wearing {{outfit}}. He lifts a glass in one hand toward the far end of the table and lowers it naturally. The brief eye contact goes to the lens. A freckled red-haired man in his thirties cups a mug and looks toward the doorway, and a short woman with a blunt black bob is half standing to point at something outside. The others are gathered a couple of metres past him, and {{backdrop}} drop off five metres behind them. Pendant lamps hang over the pass behind him and glow through the frame, while a wall sconce closer to the camera lights his face from the front left. A 4:3 waist-up documentary frame from across the table, Sony A7S III, 35mm, f/2, 1/160, ISO 3200. Retain distance-appropriate facial detail, warm venue colour across his skin, fabric folds, and grain carried through shadow and background alike.",
    "locations": {
  ...
  },
  {
    ...
    "promptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. At {{location}}, wearing {{outfit}}. He joins a small toast, the glass in one hand close to his chest. He smiles at the person opposite, just past the lens. An older man in a flat cap with deep smile lines cuts bread with both hands, and a wiry man in his twenties with dark curls and a hoop earring leans in to hear over the noise. The company sits opposite and slightly behind him, with {{backdrop}} ten metres back going soft. Pendant lamps hang over the pass behind him and glow through the frame, while a wall sconce closer to the camera lights his face from the front left. A modest direct flash from the camera adds a half stop of fill across his face and lays one soft shadow behind him. A 3:4 chest-up frame from a neighbouring seat, Fujifilm X100V, 23mm, f/4, 1/125, ISO 800. Flash reveals honest texture, modest shine at the forehead, fabric creases, and the weave of the table top.",
    "locations": {
      "urban": "a modern restaurant lounge",
      "outdoorsy": "a rustic lodge common room",
      "homebody": "an apartment dinner gathering"
  ...
  },
  {
    ...
    "light": "Pendant lamps hang over the pass behind him and glow through the frame, while a wall sconce closer to the camera lights his face from the front left.",
    "promptTemplate": "Use the supplied photographs for identity. Keep his face shape, skin tone, hair, beard pattern, age, and asymmetry exactly as they appear, on him alone. At {{location}}, wearing {{outfit}}. He passes a glass across with one hand and keeps his own near the table. He laughs at the thanks, eyes coming to the lens. Two women he knows are with him: an older one with silver-streaked hair pinned up, mid-sentence with a hand raised, and a younger one with tight coiled curls, looking down at her plate. The group is strung out from the near corner into the room, with {{backdrop}} six metres back and well out of focus. Pendant lamps hang over the pass behind him and glow through the frame, while a wall sconce closer to the camera lights his face from the front left. A 4:3 friend-taken medium shot from conversational distance, friend-taken iPhone 15 Pro at 35mm equivalent, standard photo mode. Preserve distance-appropriate facial detail, slight gesture motion, and ordinary phone texture with true venue colour.",
    "locations": {
      "urban": "a modern restaurant lounge",
      "outdoorsy": "a rustic lodge common room",
      "homebody": "an apartment dinner gathering"
  ...
  },
  {
    ...
    "promptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. At {{location}}, wearing {{outfit}}. He shifts one leg and drops a hand to the cushion to make room. He stays in the conversation, looking to the lens. Two men are at the table with him: a broad bald man in his fifties with a grey beard, laughing at something in his own hands, and a slim man in his twenties with straight light-brown hair, turned away toward the room. He is nearest the camera with the others further along the same side, and {{backdrop}} fall away eight metres behind into soft shape. Warm downlights sit directly overhead and pool on his hair and shoulders, with the table's pale surface throwing enough back up to keep his eyes readable. A modest direct flash from the camera adds a half stop of fill across his face and lays one soft shadow behind him. A 3:4 knee-up flash photograph with easy space around him, Fujifilm X100V, 23mm, f/4, 1/125, ISO 800. Flash reveals honest texture, modest shine at the forehead, fabric creases, and the weave of the table top.",
    "locations": {
      "urban": "a modern restaurant lounge",
      "outdoorsy": "a rustic lodge common room",
      "homebody": "an apartment dinner gathering"
  ...
  },
  {
    ...
    "promptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. At {{location}}, wearing {{outfit}}. He pushes off the wall with one hand to meet an arrival. He reacts to the lens before the handshake finishes. Two women he knows are with him: an older one with silver-streaked hair pinned up, mid-sentence with a hand raised, and a younger one with tight coiled curls, looking down at her plate. The group is strung out from the near corner into the room, with {{backdrop}} six metres back and well out of focus. Bright daylight from the open entrance behind the camera lands square on him, and the darker interior behind him holds its own deep shadow. A modest direct flash from the camera adds a half stop of fill across his face and lays one soft shadow behind him. A 3:4 waist-up snapshot with his face near the visual centre, Fujifilm X100V, 23mm, f/4, 1/125, ISO 800. Flash reveals honest texture, modest shine at the forehead, fabric creases, and the weave of the table top.",
    "locations": {
      "urban": "a modern restaurant lounge",
      "outdoorsy": "a rustic lodge common room",
      "homebody": "an apartment dinner gathering"
  ...
  },
  {
    ...
    "promptTemplate": "All references show the same man. Preserve his face, skin tone, hair, beard pattern, age, and natural asymmetry; this identity belongs to him alone. At {{location}}, wearing {{outfit}}. He lowers a small plate after a first taste, one hand under it. He looks up to the lens at the amused reaction. Two men are at the table with him: a broad bald man in his fifties with a grey beard, laughing at something in his own hands, and a slim man in his twenties with straight light-brown hair, turned away toward the room. He is nearest the camera with the others further along the same side, and {{backdrop}} fall away eight metres behind into soft shape. A fire pit low and to his right throws unsteady warm light up across his jaw and cheek, while the sky above him has gone fully dark. A 3:4 chest-up frame through a little foreground context, Sony A7S III, 35mm, f/2, 1/160, ISO 3200. Retain distance-appropriate facial detail, warm venue colour across his skin, fabric folds, and grain carried through shadow and background alike.",
    "locations": {
  ...
  },
  {
    ...
    "promptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. At {{location}}, wearing {{outfit}}. He offers the next bite across, then draws the plate back carefully with both hands. He laughs at the answer, eyes to the lens. A heavy man in his sixties with a white moustache turns a bottle in both hands at the far corner, while a tall thin man with a shaved head and glasses reaches past him for a jug. He holds the near ground and the others sit deeper into the frame, with {{backdrop}} seven metres beyond in soft light. A fire pit low and to his right throws unsteady warm light up across his jaw and cheek, while the sky above him has gone fully dark. A modest direct flash from the camera adds a half stop of fill across his face and lays one soft shadow behind him. A 4:3 medium photograph with hands and table objects fully supported, Fujifilm X100V, 23mm, f/4, 1/125, ISO 800. Flash reveals honest texture, modest shine at the forehead, fabric creases, and the weave of the table top.",
    "locations": {
      "urban": "an indoor-outdoor dinner party",
      "outdoorsy": "a sheltered campground barbecue",
      "homebody": "an apartment balcony gathering"
  ...
  },
  {
    ...
    "promptTemplate": "All references show the same man. Preserve his face, skin tone, hair, beard pattern, age, and natural asymmetry; this identity belongs to him alone. At {{location}}, wearing {{outfit}}. He steps out ahead of the others with a jacket over one forearm. He looks back to the lens at a last joke. Two women he knows are with him: an older one with silver-streaked hair pinned up, mid-sentence with a hand raised, and a younger one with tight coiled curls, looking down at her plate. The group is strung out from the near corner into the room, with {{backdrop}} six metres back and well out of focus. A doorway of warm interior light behind his shoulder outlines him from behind, and a cooler porch bulb ahead picks up his face at three-quarters from the front. A 4:3 environmental frame that explains the gathering, Sony A7S III, 35mm, f/2, 1/160, ISO 3200. Retain distance-appropriate facial detail, warm venue colour across his skin, fabric folds, and grain carried through shadow and background alike.",
    "locations": {
      "urban": "an indoor-outdoor dinner party",
      "outdoorsy": "a sheltered campground barbecue",
      "homebody": "an apartment balcony gathering"
  ...
  },
  {
    ...
    "promptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. At {{location}}, wearing {{outfit}}. He holds the door with one hand while the others pass, then follows. He is still smiling toward the lens as he releases it. A freckled red-haired man in his thirties cups a mug and looks toward the doorway, and a short woman with a blunt black bob is half standing to point at something outside. The others are gathered a couple of metres past him, and {{backdrop}} drop off five metres behind them. A doorway of warm interior light behind his shoulder outlines him from behind, and a cooler porch bulb ahead picks up his face at three-quarters from the front. A modest direct flash from the camera adds a half stop of fill across his face and lays one soft shadow behind him. A 9:16 full-body flash photograph with room at the edges, Fujifilm X100V, 23mm, f/4, 1/125, ISO 800. Flash reveals honest texture, modest shine at the forehead, fabric creases, and the weave of the table top.",
    "locations": {
      "urban": "an indoor-outdoor dinner party",
      "outdoorsy": "a sheltered campground barbecue",
      "homebody": "an apartment balcony gathering"
  ...
  },
  {
    ...
    "light": "A doorway of warm interior light behind his shoulder outlines him from behind, and a cooler porch bulb ahead picks up his face at three-quarters from the front.",
    "promptTemplate": "Use the supplied photographs for identity. Keep his face shape, skin tone, hair, beard pattern, age, and asymmetry exactly as they appear, on him alone. At {{location}}, wearing {{outfit}}. He walks away from the entrance with both hands in his pockets, keeping pace. He turns to the lens while everyone keeps moving. An older man in a flat cap with deep smile lines cuts bread with both hands, and a wiry man in his twenties with dark curls and a hoop earring leans in to hear over the noise. The company sits opposite and slightly behind him, with {{backdrop}} ten metres back going soft. A doorway of warm interior light behind his shoulder outlines him from behind, and a cooler porch bulb ahead picks up his face at three-quarters from the front. A 9:16 full-body candid that keeps ordinary movement, friend-taken iPhone 15 Pro at 35mm equivalent, standard photo mode. Preserve distance-appropriate facial detail, slight gesture motion, and ordinary phone texture with true venue colour.",
    "locations": {
      "urban": "an indoor-outdoor dinner party",
      "outdoorsy": "a sheltered campground barbecue",
      "homebody": "an apartment balcony gathering"
  ...
  },
  {
    ...
    "light": "Open daylight comes from a bright but clouded sky almost overhead, lighting him evenly with a soft shadow under his brow and the path throwing a weak fill back up.",
    "promptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. At {{location}}, wearing {{outfit}}. He waits while the dog investigates the verge, the loop of lead hanging from one hand. He glances to the lens with an affectionate expression. {{backdrop}} sit twenty-five metres beyond him, dropping into soft outdoor depth. Open daylight comes from a bright but clouded sky almost overhead, lighting him evenly with a soft shadow under his brow and the path throwing a weak fill back up. A 9:16 friend-taken full-body frame from a safe practical distance, friend-taken iPhone 15 Pro burst, 35mm equivalent, standard photo mode. Preserve believable mechanics, movement outside the face, distance-appropriate skin, and ordinary phone texture.",
    "locations": {
      "urban": "a broad urban park path",
      "outdoorsy": "a lakeside trail",
      "homebody": "a leafy neighborhood greenway"
  ...
  },
  {
    ...
    "light": "Morning sun sits low behind him and rims his shoulders and the back of his head, while the pale path in front bounces enough light to hold his face a stop under it.",
    "promptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. At {{location}}, wearing {{outfit}}. He reaches a flatter stretch and loosens one pack strap with his thumb. He smiles to the lens while his breathing settles. Fifteen metres behind him, {{backdrop}} blur gently with the movement of the air. Morning sun sits low behind him and rims his shoulders and the back of his head, while the pale path in front bounces enough light to hold his face a stop under it. A 9:16 three-quarter burst photograph with ordinary perspective, friend-taken iPhone 15 Pro burst, 35mm equivalent, standard photo mode. Preserve believable mechanics, movement outside the face, distance-appropriate skin, and ordinary phone texture.",
    "locations": {
      "urban": "a broad urban park path",
      "outdoorsy": "a lakeside trail",
      "homebody": "a leafy neighborhood greenway"
  ...
  },
  {
    ...
    "light": "Even light from a white sky reaches him from above and every side at once, so his face holds gentle modelling and the shadows under him stay soft.",
    "promptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. At {{location}}, wearing {{outfit}}. He stops where the path forks, a hand flat on a timber post, and picks his line. He turns to the lens with the route chosen. The ground runs back ten metres to {{backdrop}}, held just out of focus. Even light from a white sky reaches him from above and every side at once, so his face holds gentle modelling and the shadows under him stay soft. A 3:4 knee-up candid with small natural movement at the edges, friend-taken iPhone 15 Pro burst, 35mm equivalent, standard photo mode. Preserve believable mechanics, movement outside the face, distance-appropriate skin, and ordinary phone texture.",
    "locations": {
      "urban": "a forest exercise clearing",
      "outdoorsy": "a lodge deck beside trees",
      "homebody": "a quiet local park lawn"
  ...
  },
  {
    ...
    "light": "Warm side light comes from his left through a gap in the trees and models one half of his face, with the other half falling into cool shade.",
    "promptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. At {{location}}, wearing {{outfit}}. He stops where the path opens and turns into the warm light, thumbs hooked in his waistband. He smiles to the lens before going on. Eighteen metres back, {{backdrop}} lose their edges while the ground between stays readable. Warm side light comes from his left through a gap in the trees and models one half of his face, with the other half falling into cool shade. A 9:16 three-quarter burst photograph with ordinary perspective, friend-taken iPhone 15 Pro burst, 35mm equivalent, standard photo mode. Preserve believable mechanics, movement outside the face, distance-appropriate skin, and ordinary phone texture.",
    "locations": {
      "urban": "a riverside running route",
      "outdoorsy": "a golden-hour trail path",
      "homebody": "a familiar park loop"
  ...
  },
  {
    ...
    "light": "Flat grey daylight comes from the whole sky above him, giving him soft even modelling and a quiet shadow beneath the bench.",
    "promptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. At {{location}}, wearing {{outfit}}. He drapes a small towel round his neck and keeps one hand on each end. He smiles to the lens as the conversation restarts. Fifteen metres behind him, {{backdrop}} blur gently with the movement of the air. Flat grey daylight comes from the whole sky above him, giving him soft even modelling and a quiet shadow beneath the bench. A 3:4 knee-up candid with small natural movement at the edges, friend-taken iPhone 15 Pro burst, 35mm equivalent, standard photo mode. Preserve believable mechanics, movement outside the face, distance-appropriate skin, and ordinary phone texture.",
    "locations": {
      "urban": "a shaded city-park bench",
      "outdoorsy": "a trailhead rest bench",
      "homebody": "a neighborhood park bench"
  ...
  },
  {
    ...
    "light": "Low sun comes from his right and slightly behind, catching the edge of his cheekbone and jaw while the front of his face rides on bounce off the ground.",
    "promptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. At {{location}}, wearing {{outfit}}. He slows to a stop and puts one foot down, a hand still on the brake hood. His eyes go back along the route, past the lens. The ground runs back ten metres to {{backdrop}}, held just out of focus. Low sun comes from his right and slightly behind, catching the edge of his cheekbone and jaw while the front of his face rides on bounce off the ground. A 3:4 medium snapshot that keeps the face identifiable, friend-taken iPhone 15 Pro burst, 35mm equivalent, standard photo mode. Preserve believable mechanics, movement outside the face, distance-appropriate skin, and ordinary phone texture.",
    "locations": {
      "urban": "a shaded city-park bench",
      "outdoorsy": "a trailhead rest bench",
      "homebody": "a neighborhood park bench"
  ...
  },
  {
    ...
    "light": "Sun sits behind the ridge ahead of him so the sky is bright, and his face is lit softly from the front by everything that light reflects off.",
    "promptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. At {{location}}, wearing {{outfit}}. He finishes a simple wall stretch with both palms flat against it and steps back onto the path. He smiles to the lens. The path opens twelve metres behind him to {{backdrop}}, which soften as the ground falls away. Sun sits behind the ridge ahead of him so the sky is bright, and his face is lit softly from the front by everything that light reflects off. A 9:16 three-quarter burst photograph with ordinary perspective, friend-taken iPhone 15 Pro burst, 35mm equivalent, standard photo mode. Preserve believable mechanics, movement outside the face, distance-appropriate skin, and ordinary phone texture.",
    "hobbyPromptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. A friend photographs him taking part in {{hobby}}; he completes a small action and checks the result in his hands. He reacts with his eyes coming up to the lens. Ten metres of the venue open up behind him, the activity's surroundings softening into ordinary blur. Daylight reaches him from above and slightly to one side, modelling his face and leaving a soft shadow down the far cheek, with the space behind him sitting a stop darker. A 9:16 three-quarter burst photograph with ordinary perspective, friend-taken iPhone 15 Pro burst, 35mm equivalent, standard photo mode. Preserve believable mechanics, movement outside the face, distance-appropriate skin, and ordinary phone texture.",
    "locations": {
      "urban": "a landscaped hill path",
      "outdoorsy": "a moderate mountain trail",
      "homebody": "a sloped local greenway"
  ...
  },
  {
    ...
    "hobbyPromptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. A friend catches him mid-session at {{hobby}}; he adjusts something with his fingers and sets it back down. He looks up to the lens, keeping the posture he was already in. Fourteen metres of the space sit behind him, everyday clutter reading softly out of focus. Daylight reaches him from above and slightly to one side, modelling his face and leaving a soft shadow down the far cheek, with the space behind him sitting a stop darker. A 4:3 environmental snapshot that includes the path, friend-taken iPhone 15 Pro burst, 35mm equivalent, standard photo mode. Preserve believable mechanics, movement outside the face, distance-appropriate skin, and ordinary phone texture.",
    "locations": {
      "urban": "a landscaped hill path",
      "outdoorsy": "a moderate mountain trail",
      "homebody": "a sloped local greenway"
  ...
  },
  {
    ...
    "hobbyPromptTemplate": "Use the supplied photographs for identity. Keep his face shape, skin tone, hair, beard pattern, age, and asymmetry exactly as they appear, on him alone. In the middle of {{hobby}} he steadies the equipment with one hand and finishes the movement with the other. He turns to the photographer as it ends, eyes to the lens. The room or ground behind him opens out sixteen metres and holds soft, honest detail. Daylight reaches him from above and slightly to one side, modelling his face and leaving a soft shadow down the far cheek, with the space behind him sitting a stop darker. A 4:3 environmental portrait with natural outdoor depth, Fujifilm X-T5, 33mm, f/2.8, 1/500, ISO 400. Keep natural posture, accurate equipment, modest skin warmth, real breathing effort, and honest contrast.",
    "locations": {
      "urban": "a landscaped hill path",
      "outdoorsy": "a moderate mountain trail",
      "homebody": "a sloped local greenway"
  ...
  },
  {
    ...
    "light": "A high bright overcast lights the whole field evenly from above, and the mown grass lifts a faint green fill under his chin.",
    "promptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. At {{location}}, wearing {{outfit}}. He carries a ball loosely under one arm, the other hand swinging free as he walks off. He smiles to the lens. {{backdrop}} sit twenty-five metres beyond him, dropping into soft outdoor depth. A high bright overcast lights the whole field evenly from above, and the mown grass lifts a faint green fill under his chin. A 3:4 knee-up candid with small natural movement at the edges, friend-taken iPhone 15 Pro burst, 35mm equivalent, standard photo mode. Preserve believable mechanics, movement outside the face, distance-appropriate skin, and ordinary phone texture.",
    "hobbyPromptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. A friend photographs a quiet moment in {{hobby}}; his hands rest on the equipment while he thinks the next part through. He glances to the lens. Eleven metres behind him the space carries on, softening into plain background tone. Daylight reaches him from above and slightly to one side, modelling his face and leaving a soft shadow down the far cheek, with the space behind him sitting a stop darker. A 3:4 knee-up candid with small natural movement at the edges, friend-taken iPhone 15 Pro burst, 35mm equivalent, standard photo mode. Preserve believable mechanics, movement outside the face, distance-appropriate skin, and ordinary phone texture.",
    "locations": {
      "urban": "an open city-park lawn",
      "outdoorsy": "a meadow near a lodge",
      "homebody": "a broad neighborhood recreation field"
  ...
  },
  {
    ...
    "light": "The last warm light of the day comes almost level from behind the camera, lighting his face fully from the front while the ground behind him drops into shadow.",
    "promptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. At {{location}}, wearing {{outfit}}. He claps the dust off his palms once and pushes his hair back. He turns to the lens as the group breaks up. Fifteen metres behind him, {{backdrop}} blur gently with the movement of the air. The last warm light of the day comes almost level from behind the camera, lighting his face fully from the front while the ground behind him drops into shadow. A 3:4 medium snapshot that keeps the face identifiable, friend-taken iPhone 15 Pro burst, 35mm equivalent, standard photo mode. Preserve believable mechanics, movement outside the face, distance-appropriate skin, and ordinary phone texture.",
    "hobbyPromptTemplate": "Every reference shows this same man. Keep his face, complexion, hair, grooming, age, and real asymmetries exactly as they are, and give this face to him alone. Photograph him fresh in the scene below. A friend catches the end of a session of {{hobby}}; he packs one item away with both hands and pauses. He smiles to the lens. The place opens nine metres behind him into a soft, ordinary middle ground. Daylight reaches him from above and slightly to one side, modelling his face and leaving a soft shadow down the far cheek, with the space behind him sitting a stop darker. A 3:4 medium snapshot that keeps the face identifiable, friend-taken iPhone 15 Pro burst, 35mm equivalent, standard photo mode. Preserve believable mechanics, movement outside the face, distance-appropriate skin, and ordinary phone texture.",
    "locations": {
      "urban": "an open city-park lawn",
      "outdoorsy": "a meadow near a lodge",
      "homebody": "a broad neighborhood recreation field"
