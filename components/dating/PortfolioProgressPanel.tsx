      ...
      <div className="flex items-start gap-4">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-2 max-w-2xl text-sm leading-6 text-zinc-500">
            {blocked
              ? "The provider rejected its request configuration. Automatic retries are paused so one error cannot create repeated paid calls. Deploy the fix, then use Retry setup."
