...
export const publicRoutes = [
  ...
  { path: "/guides/tinder-photos", locales: englishOnly, indexable: true, sitemap: true },
  { path: "/guides/hinge-photos", locales: englishOnly, indexable: true, sitemap: true },
  { path: "/guides/bumble-photos", locales: englishOnly, indexable: true, sitemap: true },
