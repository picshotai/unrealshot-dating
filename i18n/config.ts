...
export const publicRoutes = [
  ...
  { path: "/dating-photos/examples", locales: publishedPublicLocales, indexable: true, sitemap: true },
  { path: "/dating-photos/activity", locales: publishedPublicLocales, indexable: true, sitemap: true },
  { path: "/dating-photos/tinder", locales: publishedPublicLocales, indexable: true, sitemap: true },
  { path: "/dating-photos/hinge", locales: publishedPublicLocales, indexable: true, sitemap: true },
  { path: "/dating-photos/bumble", locales: publishedPublicLocales, indexable: true, sitemap: true },
