    ...
    <div className="min-h-screen bg-[#F7F5F3] font-[family-name:var(--font-inter)] text-gray-900">
      ...
      <main className="pt-20 md:pt-24 pb-20">
        <section className="px-4 py-12 sm:py-16 max-w-5xl mx-auto text-center">
          ...
          <Link href="/login"><Button className="group relative bg-[#ff6f00] hover:bg-[#ff6f00]/90 text-white rounded-md overflow-hidden cursor-pointer px-8 pr-16 py-6 font-semibold text-base shadow-lg shadow-orange-500/20">{t("hero.button")}</Button></Link>
